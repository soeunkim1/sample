/*
 * App URI: app/ccr/extCcrSNotStudList
 * Source Location: app/ccr/extCcrSNotStudList.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/ccr/extCcrSNotStudList", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "/ccr/ExtCcrNotStudList/";
			...
			submission_2.action = "/ccr/ExtCcrNotStudList/";
			...
			(function(container){
				...
				var checkBox_1 = new cpr.controls.CheckBox("ckbNewStud");
				checkBox_1.value = "";
				checkBox_1.trueValue = "Y";
				checkBox_1.falseValue = "";
				checkBox_1.text = "신입생조회";
				checkBox_1.bind("value").toDataMap(app.lookup("dmReqKey"), "strNewStud");
