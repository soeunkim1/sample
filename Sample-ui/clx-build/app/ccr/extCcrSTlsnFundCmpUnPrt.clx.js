/*
 * App URI: app/ccr/extCcrSTlsnFundCmpUnPrt
 * Source Location: app/ccr/extCcrSTlsnFundCmpUnPrt.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/ccr/extCcrSTlsnFundCmpUnPrt", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			var dataSet_2 = new cpr.data.DataSet("dsDivList");
			dataSet_2.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"}
			...
			submission_1.action = "/ccr/ExtCcrTlsnFundCmpUnPrt/";
			...
			submission_3.action = "/ccr/ExtCcrTlsnFundCmpUnPrt/";
			...
			(function(container){
				...
				var output_3 = new cpr.controls.Output("optDiv");
				output_3.value = "";
				...
				comboBox_3.bind("fieldLabel").toExpression("#optDiv.value");
				comboBox_3.bind("value").toDataMap(app.lookup("dmReqKey"), "strDiv");
				(function(comboBox_3){
					comboBox_3.addItem(new cpr.controls.Item("선택", ""));
					comboBox_3.setItemSet(app.lookup("dsDivList"), {
						"label": "CD_NM",
						"value": "CD"
					});
				})(comboBox_3);
	...
	app.title = "미달 수강신청자 조회(총학점, 교양, 전공)";
