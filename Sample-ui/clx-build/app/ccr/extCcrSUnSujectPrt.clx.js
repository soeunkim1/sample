/*
 * App URI: app/ccr/extCcrSUnSujectPrt
 * Source Location: app/ccr/extCcrSUnSujectPrt.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/ccr/extCcrSUnSujectPrt", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "/ccr/ExtCcrUnSujectPrt/";
			...
			submission_3.action = "/ccr/ExtCcrUnSujectPrt/";
			...
			(function(container){
				...
				var output_4 = new cpr.controls.Output("optSaCdNm1");
				output_4.value = "";
				...
				var radioButton_1 = new cpr.controls.RadioButton("rdSchDiv");
				radioButton_1.bind("value").toDataMap(app.lookup("dmReqKey"), "strSchDiv");
				(function(radioButton_1){
					radioButton_1.addItem(new cpr.controls.Item("전공과목", "MAJ"));
					radioButton_1.addItem(new cpr.controls.Item("교양과목", "CUT"));
				})(radioButton_1);
