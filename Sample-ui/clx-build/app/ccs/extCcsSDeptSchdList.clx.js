/*
 * App URI: app/ccs/extCcsSDeptSchdList
 * Source Location: app/ccs/extCcsSDeptSchdList.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/ccs/extCcsSDeptSchdList", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "/ccs/ExtCcsDeptSchdList/";
			...
			submission_2.action = "/ccs/ExtCcsDeptSchdList/";
			...
			(function(container){
				...
				var comboBox_4 = new cpr.controls.ComboBox("cbbDayNightDivRcd");
				comboBox_4.bind("fieldLabel").toExpression("#optCuCd.value");
				comboBox_4.bind("value").toDataMap(app.lookup("dmReqKey"), "strDayNightDivRcd");
				(function(comboBox_4){
				...
				var output_6 = new cpr.controls.Output("optCuCd2");
				output_6.value = "";
				...
				var comboBox_5 = new cpr.controls.ComboBox("cbbSbLvlRcd");
				comboBox_5.bind("fieldLabel").toExpression("#optCuCd.value");
				comboBox_5.bind("value").toDataMap(app.lookup("dmReqKey"), "strSbLvlRcd");
				(function(comboBox_5){
				...
				var output_7 = new cpr.controls.Output("optCuCd3");
				output_7.value = "";
				output_7.bind("value").toLanguage("UI-SCR-SUBGRUP");
