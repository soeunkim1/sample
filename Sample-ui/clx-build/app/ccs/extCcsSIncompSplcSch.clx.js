/*
 * App URI: app/ccs/extCcsSIncompSplcSch
 * Source Location: app/ccs/extCcsSIncompSplcSch.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/ccs/extCcsSIncompSplcSch", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			var dataMap_6 = new cpr.data.DataMap("dmResPopup");
			dataMap_6.parseData({
				"columns" : [
					{
						"name": "strLectRoomCd",
			...
			submission_1.action = "/ccs/ExtCcsIncompSplcSch/";
			...
			submission_2.action = "/ccs/ExtCcsIncompSplcSch/";
			...
			submission_3.action = "/ccs/ExtCcsIncompSplcSch/";
			...
			(function(container){
				...
				output_3.bind("value").toLanguage("UI-DB-SA_NM");
				...
				var output_4 = new cpr.controls.Output("optSaNm2");
				output_4.value = "";
				...
				var radioButton_1 = new cpr.controls.RadioButton("radSchDiv");
				radioButton_1.bind("value").toDataMap(app.lookup("dmReqKey"), "strSchDiv");
				(function(radioButton_1){
					radioButton_1.addItem(new cpr.controls.Item("개설학과기준", "CCS"));
					radioButton_1.addItem(new cpr.controls.Item("소속기준", "APS"));
				})(radioButton_1);
				if(typeof onRadSchDivValueChange == "function") {
					radioButton_1.addEventListener("value-change", onRadSchDivValueChange);
				}
				...
				output_5.value = "";
				output_5.bind("value").toLanguage("NLS-SCR-PROFNM");
				...
				if(typeof onIpbProfNmValueChange == "function") {
					inputBox_2.addEventListener("value-change", onIpbProfNmValueChange);
				}
