/*
 * App URI: app/ccs/extCcsSLectEvalPrt03
 * Source Location: app/ccs/extCcsSLectEvalPrt03.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/ccs/extCcsSLectEvalPrt03", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "/ccs/ExtCcsLectEvalPrt03/";
			...
			submission_2.action = "/ccs/ExtCcsLectEvalPrt03/";
			...
			(function(container){
				...
				var output_4 = new cpr.controls.Output("optSch1");
				output_4.value = "";
				...
				var comboBox_3 = new cpr.controls.ComboBox("cbbTlsnCnt");
				comboBox_3.userAttr({"require": "Y"});
				comboBox_3.bind("fieldLabel").toExpression("#optSch1.value");
				comboBox_3.bind("value").toDataMap(app.lookup("dmReqKey"), "strTlsnCnt");
				(function(comboBox_3){
					comboBox_3.setItemSet(app.lookup("dsListTlsnCnt"), {
						"label": "CD_NM",
						"value": "CD"
					});
				})(comboBox_3);
