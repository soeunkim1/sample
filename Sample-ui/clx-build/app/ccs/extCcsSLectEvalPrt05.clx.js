/*
 * App URI: app/ccs/extCcsSLectEvalPrt05
 * Source Location: app/ccs/extCcsSLectEvalPrt05.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/ccs/extCcsSLectEvalPrt05", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "/ccs/ExtCcsLectEvalPrt05/";
			...
			submission_2.action = "/ccs/ExtCcsLectEvalPrt05/";
			...
			(function(container){
				...
				var output_4 = new cpr.controls.Output("optProfDiv");
				output_4.value = "";
				...
				var comboBox_4 = new cpr.controls.ComboBox("cbbProfDiv");
				comboBox_4.userAttr({"require": "Y"});
				comboBox_4.bind("value").toDataMap(app.lookup("dmReqKey"), "strSchDiv");
				(function(comboBox_4){
					comboBox_4.addItem(new cpr.controls.Item("비전임교원", "CF00311"));
					comboBox_4.addItem(new cpr.controls.Item("명예교수", "CF007018"));
					comboBox_4.addItem(new cpr.controls.Item("외래교수", "CF00340"));
				})(comboBox_4);
