/*
 * App URI: app/ccs/extCcsSRealRsltRpt
 * Source Location: app/ccs/extCcsSRealRsltRpt.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/ccs/extCcsSRealRsltRpt", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			var dataMap_4 = new cpr.data.DataMap("dmResDelChk");
			dataMap_4.parseData({
				"columns" : [
					{
						"name": "strTimeSche",
			...
			submission_1.action = "/ccs/ExtCcsRealRsltRpt/";
			...
			submission_2.action = "/ccs/ExtCcsRealRsltRpt/";
			...
			(function(container){
				...
				inputBox_1.bind("value").toDataMap(app.lookup("dmResPopup"), "strLectRoomNm");
				...
				var output_4 = new cpr.controls.Output("optFromDate");
				output_4.value = "";
				...
				dateInput_1.bind("value").toDataMap(app.lookup("dmReqKey"), "strFromDate");
				...
				var output_5 = new cpr.controls.Output("optToDate");
				output_5.value = "";
				...
				dateInput_2.bind("value").toDataMap(app.lookup("dmReqKey"), "strTodate");
