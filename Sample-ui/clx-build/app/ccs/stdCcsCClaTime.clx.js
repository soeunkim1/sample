/*
 * App URI: app/ccs/stdCcsCClaTime
 * Source Location: app/ccs/stdCcsCClaTime.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/ccs/stdCcsCClaTime", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			// Header
			var dataSet_1 = new cpr.data.DataSet("dsGrxMst");
			dataSet_1.parseData({
				"info": "CCS_CLA_TIME@OBJ_CD,OBJ_DIV_RCD,LTTM,ST_TIME",
				"columns": [
					{"name": "OBJ_NM"},
					{"name": "OBJ_DIV_RCD"},
					{"name": "LTTM"},
			...
			submission_1.action = "/ccs/StdCcsClaTime/";
			...
			submission_2.action = "/ccs/StdCcsClaTime/";
			...
			submission_3.action = "/ccs/StdCcsClaTime/";
			...
			(function(container){
				...
				var button_2 = new cpr.controls.Button("rdBtnObjNm");
				button_2.value = "";
				button_2.style.setClasses(["btn-pop-search"]);
				if(typeof onRdBtnObjNmClick == "function") {
					button_2.addEventListener("click", onRdBtnObjNmClick);
				}
			...
			(function(container){
				...
				userDefinedControl_2.bind("title").toLanguage("UI-SCR-PERIODLST");
						...
						"cells": [
							...
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										var inputBox_2 = new cpr.controls.InputBox("gdIpbObjNm");
							...
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										var numberEditor_1 = new cpr.controls.NumberEditor("gdIpbLttm");
										numberEditor_1.spinButton = false;
										numberEditor_1.format = "9,999,999,999";
										numberEditor_1.style.css({
											"text-align" : "center"
										});
										numberEditor_1.bind("value").toDataColumn("LTTM");
							...
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										var inputBox_3 = new cpr.controls.InputBox("gdIpbLttmNm");
										inputBox_3.maxLength = 100;
										inputBox_3.userAttr({"require": "Y"});
										inputBox_3.style.css({
											"text-align" : "center"
										});
										inputBox_3.bind("value").toDataColumn("LTTM_NM");
										return inputBox_3;
									})();
								}
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										var dateInput_1 = new cpr.controls.DateInput("gdIpbStTime");
										dateInput_1.style.css({
											"text-align" : "center"
										});
										dateInput_1.bind("value").toDataColumn("ST_TIME");
										return dateInput_1;
									})();
								}
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										var dateInput_2 = new cpr.controls.DateInput("gdIpbEndTime");
										dateInput_2.userAttr({"require": "Y"});
										dateInput_2.style.css({
											"text-align" : "center"
										});
										dateInput_2.bind("value").toDataColumn("END_TIME");
										return dateInput_2;
									})();
								}
							},
							...
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										var inputBox_5 = new cpr.controls.InputBox("gdIpbObjCd");
										inputBox_5.maxLength = 10;
										inputBox_5.userAttr({"require": "Y"});
										inputBox_5.bind("value").toDataColumn("OBJ_CD");
										return inputBox_5;
									})();
								}
							}
