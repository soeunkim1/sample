/*
 * App URI: app/ccs/stdCcsCCurClsFrf2
 * Source Location: app/ccs/stdCcsCCurClsFrf2.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/ccs/stdCcsCCurClsFrf2", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			var dataSet_18 = new cpr.data.DataSet("dsCcsCurCls");
			...
			var dataSet_19 = new cpr.data.DataSet("dsFrfCcsCurCls");
			...
			var dataSet_20 = new cpr.data.DataSet("dsCcsCurClsHistory");
			...
			var dataMap_7 = new cpr.data.DataMap("dmKeyDateMap");
			dataMap_7.parseData({
				"columns" : [
					{
						"name": "BEF_DT",
			...
			var submission_4 = new cpr.protocols.Submission("subSaveHistory");
			submission_4.action = "/ccs/StdCcsCurClsFrf/";
			submission_4.mediaType = "application/x-www-form-urlencoded";
			submission_4.addRequestData(dataSet_20);
			submission_4.addRequestData(dataMap_2);
			app.register(submission_4);
			
			var submission_5 = new cpr.protocols.Submission("subListHistory");
			...
			submission_6.addRequestData(dataSet_18);
			submission_6.addRequestData(dataMap_2);
			app.register(submission_6);
			
			var submission_7 = new cpr.protocols.Submission("subSpCuList");
			...
			submission_7.addResponseData(dataSet_16, false);
			submission_7.addResponseData(dataSet_17, false);
			app.register(submission_7);
			
			var submission_8 = new cpr.protocols.Submission("subGetUpSaCd");
			...
			var submission_9 = new cpr.protocols.Submission("subDoChkCurCls");
			submission_9.action = "/ccs/StdCcsCurClsFrf/";
			submission_9.mediaType = "application/x-www-form-urlencoded";
			submission_9.addRequestData(dataMap_6);
			submission_9.addResponseData(dataMap_1, false);
			app.register(submission_9);
			
			var submission_10 = new cpr.protocols.Submission("subAllDisUse");
			submission_10.action = "/ccs/StdCcsCurClsFrf/";
			submission_10.mediaType = "application/x-www-form-urlencoded";
			submission_10.addRequestData(dataSet_18);
			...
			(function(container){
				...
				var output_38 = new cpr.controls.Output("optSaNm");
				output_38.value = "";
				output_38.style.setClasses(["require"]);
				output_38.bind("value").toLanguage("UI-DB-SA_CD_NM");
				...
				var output_39 = new cpr.controls.Output("optCuCd");
				output_39.value = "";
				output_39.style.setClasses(["require"]);
				output_39.bind("value").toLanguage("UI-SCR-SUBGRUP");
				...
				comboBox_40.userAttr({"require": "Y"});
				...
				var output_40 = new cpr.controls.Output("optSbNm");
				output_40.value = "";
				output_40.bind("value").toLanguage("UI-DB-SB_CD_NM");
				...
				var button_20 = new cpr.controls.Button("btnSbCd");
				button_20.value = "";
				button_20.style.setClasses(["btn-pop-search"]);
				if(typeof onBtnSbCdClick == "function") {
					button_20.addEventListener("click", onBtnSbCdClick);
				}
				...
				var output_41 = new cpr.controls.Output("optSpCd");
				output_41.value = "";
				output_41.bind("value").toLanguage("NLS-SCR-SPPROC");
				...
				var output_42 = new cpr.controls.Output("optCmpDivRcd");
				output_42.value = "";
				output_42.bind("value").toLanguage("UI-DB-SUB_GBN_RCD");
				...
				var output_43 = new cpr.controls.Output("optSbLvlRcd");
				output_43.value = "";
				output_43.bind("value").toLanguage("UI-GLS-SHYR");
				...
				var output_44 = new cpr.controls.Output("optEstPrdRcd");
				output_44.value = "";
				output_44.bind("value").toLanguage("UI-DB-EST_PRD");
				...
				var output_45 = new cpr.controls.Output("optKeyDate");
				output_45.value = "";
				output_45.style.setClasses(["require"]);
				output_45.bind("value").toLanguage("UI-SCR-STDDT");
				...
				var inputBox_10 = new cpr.controls.InputBox("dipKeyDate");
				inputBox_10.visible = false;
				inputBox_10.enabled = false;
				inputBox_10.maxLength = 8;
				inputBox_10.style.css({
					"text-align" : "center"
				});
				inputBox_10.bind("fieldLabel").toExpression("#optKeyDate.value");
				inputBox_10.bind("value").toDataMap(app.lookup("dmReqKey"), "strKeyDate");
				...
				var output_46 = new cpr.controls.Output("optSchYearRcd");
				output_46.value = "";
				output_46.style.setClasses(["require"]);
				output_46.bind("value").toLanguage("UI-GLS-SCH_YEAR");
				...
				var comboBox_45 = new cpr.controls.ComboBox("cbbSchYearRcd");
				comboBox_45.enabled = false;
				comboBox_45.userAttr({"require": "Y"});
				comboBox_45.bind("fieldLabel").toExpression("#optSchYearRcd.value");
				comboBox_45.bind("value").toDataMap(app.lookup("dmKeyDateMap"), "YEAR");
				(function(comboBox_45){
					comboBox_45.addItem(new cpr.controls.Item("선택", ""));
					comboBox_45.setItemSet(app.lookup("dsSchYearRcdList"), {
						"label": "CD_NM",
						"value": "CD"
					});
				})(comboBox_45);
				if(typeof onCbbSchYearRcdSelectionChange == "function") {
					comboBox_45.addEventListener("selection-change", onCbbSchYearRcdSelectionChange);
				}
				...
				var output_47 = new cpr.controls.Output("optSmtRcd");
				output_47.value = "";
				output_47.style.setClasses(["require"]);
				output_47.bind("value").toLanguage("NLS-DLG-LBL-L002");
				...
				var comboBox_46 = new cpr.controls.ComboBox("cbbSmtRcd");
				comboBox_46.enabled = false;
				comboBox_46.userAttr({"require": "Y"});
				comboBox_46.bind("fieldLabel").toExpression("#optSmtRcd.value");
				comboBox_46.bind("value").toDataMap(app.lookup("dmKeyDateMap"), "SMT");
				(function(comboBox_46){
					comboBox_46.addItem(new cpr.controls.Item("선택", ""));
					comboBox_46.setItemSet(app.lookup("dsSmtRcdList"), {
						"label": "CD_NM",
						"value": "CD"
					});
				})(comboBox_46);
				if(typeof onCbbSmtRcdSelectionChange == "function") {
					comboBox_46.addEventListener("selection-change", onCbbSmtRcdSelectionChange);
				}
