/*
 * App URI: app/cgd/extCgdCAttendScrCii
 * Source Location: app/cgd/extCgdCAttendScrCii.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/cgd/extCgdCAttendScrCii", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			// Header
			var dataSet_1 = new cpr.data.DataSet("dsExtCgdAttendScr");
			dataSet_1.parseData({
				"info": "EXT_CGD_ATTEND_SCR@WEEK_TC,ABN_TC",
				"columns": [
					{"name": "WEEK_TC"},
					{"name": "ABN_TC"},
					{"name": "ALLOT_POINT"}
			...
			submission_1.action = "/cgd/ExtCgdAttendScrCii/";
			submission_1.mediaType = "application/x-www-form-urlencoded";
			submission_1.addResponseData(dataSet_1, false);
			app.register(submission_1);
			
			var submission_2 = new cpr.protocols.Submission("subSave");
			submission_2.action = "/cgd/ExtCgdAttendScrCii/";
			...
			(function(container){
				...
				userDefinedControl_2.bind("title").toLanguage("UI-SCR-ABNTIMECNT");
				...
				var grid_1 = linker.grid_1 = new cpr.controls.Grid("grdExtCgdAttendScr");
				grid_1.init({
					"dataSet": app.lookup("dsExtCgdAttendScr"),
					"columns": [
						{"width": "25px"},
						{"width": "25px"},
						{"width": "40px"},
						...
						"cells": [
							...
							},
							{
								...
								"configurator": function(cell){
									...
									cell.bind("text").toLanguage("UI-DB-WEEK_TC");
								}
							},
							{
								...
								"configurator": function(cell){
									cell.style.setClasses(["require"]);
									cell.bind("text").toLanguage("UI-DB-ABN_TC");
								}
							},
							{
								"constraint": {"rowIndex": 0, "colIndex": 5},
								"configurator": function(cell){
									cell.bind("text").toLanguage("UI-GLS-ALLOT_POINT");
								}
							}
						]
					},
					"detail": {
						...
						"cells": [
							...
							},
							{
								"constraint": {"rowIndex": 0, "colIndex": 3},
								"configurator": function(cell){
									cell.columnName = "WEEK_TC";
									cell.control = (function(){
										var numberEditor_1 = new cpr.controls.NumberEditor("gdIpbWeekTc");
										numberEditor_1.spinButton = false;
										numberEditor_1.format = "999";
										numberEditor_1.userAttr({"require": "Y"});
										numberEditor_1.bind("value").toDataColumn("WEEK_TC");
							...
							},
							{
								"constraint": {"rowIndex": 0, "colIndex": 4},
								"configurator": function(cell){
									cell.columnName = "ABN_TC";
									cell.control = (function(){
										var numberEditor_2 = new cpr.controls.NumberEditor("gdIpbAbnTc");
										numberEditor_2.spinButton = false;
										numberEditor_2.format = "999";
										numberEditor_2.userAttr({"require": "Y"});
										numberEditor_2.bind("value").toDataColumn("ABN_TC");
							...
							},
							{
								"constraint": {"rowIndex": 0, "colIndex": 5},
								"configurator": function(cell){
									cell.columnName = "ALLOT_POINT";
									cell.control = (function(){
										var numberEditor_3 = new cpr.controls.NumberEditor("gdIpbAllotPoint");
										numberEditor_3.spinButton = false;
										numberEditor_3.format = "999";
										numberEditor_3.bind("value").toDataColumn("ALLOT_POINT");
