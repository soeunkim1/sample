/*
 * App URI: app/cgd/extCgdSDeptRecIqy
 * Source Location: app/cgd/extCgdSDeptRecIqy.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/cgd/extCgdSDeptRecIqy", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			// Header
			var dataSet_1 = new cpr.data.DataSet("dsListStatRcd");
			dataSet_1.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"}
			...
			submission_1.action = "/cgd/ExtCgdDeptRecIqy/";
			...
			submission_2.action = "/cgd/ExtCgdDeptRecIqy/";
			...
			(function(container){
				...
				var output_7 = new cpr.controls.Output("optListStatRcd");
				output_7.value = "학적상태";
				...
				var comboBox_3 = new cpr.controls.ComboBox("cbbListStatRcd");
				comboBox_3.bind("value").toDataMap(app.lookup("dmReqKey"), "strListStatRcd");
				(function(comboBox_3){
					comboBox_3.addItem(new cpr.controls.Item("전체", ""));
					comboBox_3.setItemSet(app.lookup("dsListStatRcd"), {
						"label": "CD_NM",
						"value": "CD"
					});
				})(comboBox_3);
				...
				var inputBox_3 = new cpr.controls.InputBox("ipbClassRcd");
				inputBox_3.bind("value").toDataMap(app.lookup("dmReqKey"), "strClassRcd");
