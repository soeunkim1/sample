/*
 * App URI: app/cgd/extCgdSRecSheet
 * Source Location: app/cgd/extCgdSRecSheet.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/cgd/extCgdSRecSheet", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				var output_5 = new cpr.controls.Output("optOgCdNm");
				output_5.value = "";
				...
				var inputBox_3 = new cpr.controls.InputBox("ipbOgCdNm");
				inputBox_3.maxLength = 100;
				inputBox_3.userAttr({"require": "Y"});
				inputBox_3.bind("fieldLabel").toExpression("#optOgCdNm.value");
				inputBox_3.bind("value").toDataMap(app.lookup("dmReqKey"), "strOgNm");
				if(typeof onIpbOgCdNmValueChange == "function") {
					inputBox_3.addEventListener("value-change", onIpbOgCdNmValueChange);
				}
				...
				var button_4 = new cpr.controls.Button("btnOgCdNm");
				button_4.value = "";
				button_4.style.setClasses(["btn-pop-search"]);
				if(typeof onBtnOgCdNmClick == "function") {
					button_4.addEventListener("click", onBtnOgCdNmClick);
				}
