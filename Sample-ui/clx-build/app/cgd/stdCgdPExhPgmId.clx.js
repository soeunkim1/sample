/*
 * App URI: app/cgd/stdCgdPExhPgmId
 * Source Location: app/cgd/stdCgdPExhPgmId.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/cgd/stdCgdPExhPgmId", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			// Header
			var dataSet_1 = new cpr.data.DataSet("dsExhStud");
			dataSet_1.parseData({
				"columns": [
					{"name": "EXH_NM"},
					{"name": "OT_NM"},
			...
			(function(container){
				var grid_1 = linker.grid_1 = new cpr.controls.Grid("grdExhStud");
				grid_1.init({
					"dataSet": app.lookup("dsExhStud"),
					"columns": [
						{"width": "40px"},
						{"width": "80px"},
						{"width": "120px"},
					...
					"header": {
						...
						"cells": [
							...
							},
							{
								...
								"configurator": function(cell){
									cell.bind("text").toLanguage("NLS-SCR-STDT");
								}
							},
							{
								"constraint": {"rowIndex": 0, "colIndex": 5},
								"configurator": function(cell){
									cell.bind("text").toLanguage("NLS-SCR-ENDT");
								}
							},
							{
								"constraint": {"rowIndex": 0, "colIndex": 6},
								"configurator": function(cell){
									cell.bind("text").toLanguage("UI-SCR-EXCHGPGCAT");
								}
							},
							{
				...
				if(typeof onGrdExhStudDblclick == "function") {
					grid_1.addEventListener("dblclick", onGrdExhStudDblclick);
				}
