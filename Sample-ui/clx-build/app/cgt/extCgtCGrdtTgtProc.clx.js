/*
 * App URI: app/cgt/extCgtCGrdtTgtProc
 * Source Location: app/cgt/extCgtCGrdtTgtProc.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/cgt/extCgtCGrdtTgtProc", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			var dataMap_3 = new cpr.data.DataMap("dmBatchRslt");
			dataMap_3.parseData({
				"columns" : [
					{
						"name": "TARGET_CNT",
			...
			var dataMap_4 = new cpr.data.DataMap("dmCgtSchYearSmtRcdInfo");
			dataMap_4.parseData({
				"columns" : [
					{
						"name": "SCH_YEAR_RCD",
			...
			submission_1.action = "/cgt/ExtCgtGrdtTgtProc/";
			...
			submission_2.action = "/cgt/ExtCgtGrdtTgtProc/";
			...
			button_1.bind("value").toLanguage("UI-SCR-GRADUTGTSLT");
			...
			output_3.value = "* 졸업대상자선정은 해당학기의 모든 학적변동처리가 완료된 후 최종적으로 처리하셔야 합니다.";
