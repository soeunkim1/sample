/*
 * App URI: app/cgt/extCgtSGrdtTgtCgdListPrt
 * Source Location: app/cgt/extCgtSGrdtTgtCgdListPrt.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/cgt/extCgtSGrdtTgtCgdListPrt", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "/cgt/ExtCgtGrdtTgtCgdListPrt/";
			...
			(function(container){
				...
				var output_2 = new cpr.controls.Output("optStId");
				output_2.value = "";
				...
				checkBox_1.text = "재수강 성적 포함";
				checkBox_1.bind("value").toDataMap(app.lookup("dmReqKey"), "strReRecYn");
			...
			var embeddedApp_3 = new cpr.controls.EmbeddedApp("emaStdCsrPStSearch");
