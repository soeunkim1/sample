/*
 * App URI: app/cgt/stdCgtCYearSmt
 * Source Location: app/cgt/stdCgtCYearSmt.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/cgt/stdCgtCYearSmt", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "/cgt/StdCgtYearSmt/";
			...
			submission_2.action = "/cgt/StdCgtYearSmt/";
			...
			(function(container){
				...
				comboBox_1.bind("value").toDataMap(app.lookup("dmYearSmt"), "SCH_YEAR_RCD");
				(function(comboBox_1){
				...
				comboBox_2.bind("value").toDataMap(app.lookup("dmYearSmt"), "SMT_RCD");
				(function(comboBox_2){
