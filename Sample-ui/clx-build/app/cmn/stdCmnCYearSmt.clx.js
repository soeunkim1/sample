/*
 * App URI: app/cmn/stdCmnCYearSmt
 * Source Location: app/cmn/stdCmnCYearSmt.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/cmn/stdCmnCYearSmt", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			var dataMap_1 = new cpr.data.DataMap("dmDefYearSmt");
			dataMap_1.parseData({
				"columns" : [
					{
						"name": "CD_PRP1",
			...
			submission_1.action = "/cmn/StdCmnYearSmt/";
			...
			submission_2.action = "/cmn/StdCmnYearSmt/";
			...
			(function(container){
				...
				comboBox_1.bind("value").toDataMap(app.lookup("dmDefYearSmt"), "CD_PRP1");
				(function(comboBox_1){
				...
				comboBox_2.bind("value").toDataMap(app.lookup("dmDefYearSmt"), "CD_PRP2");
				(function(comboBox_2){
