/*
 * App URI: app/crs/extCrsSRegFeeTgtListPrt
 * Source Location: app/crs/extCrsSRegFeeTgtListPrt.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/crs/extCrsSRegFeeTgtListPrt", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "/crs/ExtCrsRegFeeTgtListPrt/";
			submission_1.mediaType = "application/x-www-form-urlencoded";
			submission_1.addResponseData(dataSet_1, false);
			app.register(submission_1);
			
			var submission_2 = new cpr.protocols.Submission("subList");
			submission_2.action = "/crs/ExtCrsRegFeeTgtListPrt/";
			...
			(function(container){
				...
				var output_2 = new cpr.controls.Output("optRegClsRcd");
				output_2.value = "";
				output_2.bind("value").toLanguage("UI-SCR-REGSTUDIV");
