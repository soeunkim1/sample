/*
 * App URI: app/crs/stdCrsPBankPop
 * Source Location: app/crs/stdCrsPBankPop.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/crs/stdCrsPBankPop", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			// Header
			var dataSet_1 = new cpr.data.DataSet("dsBank");
			dataSet_1.parseData({
				"columns": [
					{"name": "CD_NM"},
					{"name": "CD"}
			...
			(function(container){
				var inputBox_1 = new cpr.controls.InputBox("ipbBankRcdNm");
				inputBox_1.maxLength = 100;
				inputBox_1.bind("fieldLabel").toExpression("#optBankNm.value");
				inputBox_1.bind("value").toDataMap(app.lookup("dmReqKey"), "strBankRcdNm");
				if(typeof onIpbBankRcdNmKeydown == "function") {
					inputBox_1.addEventListener("keydown", onIpbBankRcdNmKeydown);
				}
				...
				var output_1 = new cpr.controls.Output("optBankNm");
				output_1.value = "";
				output_1.bind("value").toLanguage("UI-SCR-BANKNM");
			...
			(function(container){
				...
				userDefinedControl_2.bind("title").toLanguage("UI-SCR-BANKCDLST");
				...
				var grid_1 = linker.grid_1 = new cpr.controls.Grid("grdBank");
				grid_1.init({
					"dataSet": app.lookup("dsBank"),
					"columns": [
						{"width": "40px"},
						{"width": "145px"},
						{"width": "145px"}
					...
					"header": {
						...
						"cells": [
							...
							},
							{
								...
								"configurator": function(cell){
									cell.bind("text").toLanguage("UI-DB-BANK_RCD");
								}
							},
							{
								"constraint": {"rowIndex": 0, "colIndex": 2},
								"configurator": function(cell){
									cell.bind("text").toLanguage("UI-SCR-BANKNM");
								}
							}
						]
					},
				...
				if(typeof onGrdBankRowDblclick == "function") {
					grid_1.addEventListener("row-dblclick", onGrdBankRowDblclick);
				}
