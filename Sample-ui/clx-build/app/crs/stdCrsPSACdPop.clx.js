/*
 * App URI: app/crs/stdCrsPSACdPop
 * Source Location: app/crs/stdCrsPSACdPop.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/crs/stdCrsPSACdPop", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				var inputBox_1 = new cpr.controls.InputBox("ipbObjCdNm");
				...
				if(typeof onIpbObjCdNmKeydown == "function") {
					inputBox_1.addEventListener("keydown", onIpbObjCdNmKeydown);
				}
			...
			(function(container){
				...
				userDefinedControl_2.bind("title").toLanguage("UI-SCR-SADEPLST");
					...
					"header": {
						...
						"cells": [
							...
							},
							{
								...
								"configurator": function(cell){
									cell.bind("text").toLanguage("NLS-SCR-SANM");
								}
							},
							{
