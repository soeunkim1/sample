/*
 * App URI: app/csr/extCsrPAplyAbs
 * Source Location: app/csr/extCsrPAplyAbs.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/csr/extCsrPAplyAbs", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			var dataSet_5 = new cpr.data.DataSet("dsAplyStatRcdList");
			dataSet_5.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"}
			...
			var dataMap_2 = new cpr.data.DataMap("dmFrfExtCsrShregAltAply");
			dataMap_2.parseData({
				"columns" : [
					{
						"name": "STUD_ID",
			...
			submission_1.action = "/csr/ExtCsrAplyAbs/";
			...
			submission_2.action = "/csr/ExtCsrAplyAbs/";
			...
			submission_3.action = "/csr/ExtCsrAplyAbs/";
			...
			(function(container){
				...
				(function(container){
					...
					output_2.bind("value").toLanguage("UI-SCR-ABSSMSTR");
					...
					var output_3 = new cpr.controls.Output("optFrfRtnSmtRcd");
					output_3.value = "";
					output_3.bind("value").toLanguage("UI-SCR-RTRSCHSMSTR");
					...
					var output_4 = new cpr.controls.Output("optFrfAplyDt");
					output_4.value = "";
					output_4.style.setClasses(["require"]);
					output_4.bind("value").toLanguage("UI-DB-REQ_DT");
					...
					var output_5 = new cpr.controls.Output("optFrfRtnSchYearRcd");
					output_5.value = "";
					output_5.bind("value").toLanguage("UI-SCR-RTRSCHYS");
					...
					var output_7 = new cpr.controls.Output("optFrfSerialNo");
					output_7.value = "순번";
					...
					var output_8 = new cpr.controls.Output("optFrfAtlRsnDivRcd");
					output_8.value = "";
					output_8.style.setClasses(["require"]);
					output_8.bind("value").toLanguage("UI-GLS-GENDER");
					...
					var output_9 = new cpr.controls.Output("optFrfAplyStatRcd");
					output_9.value = "";
					output_9.style.setClasses(["require"]);
					output_9.bind("value").toLanguage("UI-GLS-GENDER");
					...
					var comboBox_5 = new cpr.controls.ComboBox("cbbFrfRtnSchYearRcd");
					comboBox_5.enabled = false;
					comboBox_5.hideButton = true;
					comboBox_5.style.css({
						"text-align" : "center"
					});
					comboBox_5.bind("fieldLabel").toExpression("#optFrfRtnSchYearRcd.value");
					comboBox_5.bind("value").toDataMap(app.lookup("dmFrfExtCsrShregAltAply"), "RTN_SCH_YEAR_RCD");
					(function(comboBox_5){
					...
					var comboBox_6 = new cpr.controls.ComboBox("cbbFrfRtnSmtRcd");
					comboBox_6.enabled = false;
					comboBox_6.hideButton = true;
					comboBox_6.style.css({
						"text-align" : "center"
					});
					comboBox_6.bind("fieldLabel").toExpression("#optFrfRtnSmtRcd.value");
					comboBox_6.bind("value").toDataMap(app.lookup("dmFrfExtCsrShregAltAply"), "RTN_SMT_RCD");
					(function(comboBox_6){
						comboBox_6.setItemSet(app.lookup("dsSmtRcdList"), {
							"label": "CD_NM",
							"value": "CD"
						});
					})(comboBox_6);
					...
					var output_10 = new cpr.controls.Output("optFrfAbsSmtCntRcd");
					output_10.value = "";
					...
					var comboBox_7 = new cpr.controls.ComboBox("cbbFrfAbsSmtCntRcd");
					comboBox_7.enabled = false;
					comboBox_7.hideButton = true;
					comboBox_7.style.css({
						"text-align" : "center"
					});
					comboBox_7.bind("fieldLabel").toExpression("#optFrfAbsSmtCntRcd.value");
					comboBox_7.bind("value").toDataMap(app.lookup("dmFrfExtCsrShregAltAply"), "ABS_SMT_CNT_RCD");
					(function(comboBox_7){
					...
					var output_11 = new cpr.controls.Output("optFrfAbsMsg1");
					output_11.value = "";
					output_11.bind("value").toLanguage("UI-SCR-CSRABSAPLYGUID1");
					...
					var output_12 = new cpr.controls.Output("optFrfRegTransYn");
					output_12.value = "";
					output_12.bind("value").toLanguage("UI-SCR-REGPAYMENTYN");
					...
					var inputBox_3 = new cpr.controls.InputBox("ipbFrfRegTransYn");
					inputBox_3.enabled = false;
					inputBox_3.maxLength = 30;
					inputBox_3.style.css({
						"text-align" : "center"
					});
					inputBox_3.bind("fieldLabel").toExpression("#optFrfRegTransYn.value");
					inputBox_3.bind("value").toDataMap(app.lookup("dmFrfExtCsrShregAltAply"), "REG_TRANS_YN");
					...
					var output_13 = new cpr.controls.Output("optFrfAbsMsg2");
					output_13.value = "";
					output_13.bind("value").toLanguage("UI-SCR-CSRABSAPLYGUID2");
					...
					output_14.bind("value").toLanguage("UI-DB-CST_DT");
					...
					if(typeof onIpbFrfCstDtValueChange == "function") {
						dateInput_2.addEventListener("value-change", onIpbFrfCstDtValueChange);
					}
					...
					var output_15 = new cpr.controls.Output("optFrfTempFilePath");
					output_15.value = "";
					output_15.style.setClasses(["require"]);
					output_15.bind("value").toLanguage("UI-SCR-ATCHFILE");
					...
					var inputBox_4 = new cpr.controls.InputBox("ipbFrfFileCnt");
					inputBox_4.enabled = false;
					inputBox_4.bind("fieldLabel").toExpression("#optFrfTempFilePath.value");
					inputBox_4.bind("value").toDataMap(app.lookup("dmFrfExtCsrShregAltAply"), "FILE_CNT");
					...
					var button_1 = new cpr.controls.Button("btnNewFileUpLoad");
					button_1.value = "";
					button_1.bind("value").toLanguage("UI-SCR-ATCHFILE");
					if(typeof onBtnNewFileUpLoadClick == "function") {
						button_1.addEventListener("click", onBtnNewFileUpLoadClick);
					}
					...
					var output_16 = new cpr.controls.Output("optFrfAbsMsg3");
					output_16.value = "";
					output_16.bind("value").toLanguage("UI-SCR-CSRABSAPLYGUID4");
					...
					var output_17 = new cpr.controls.Output("optFrfFileSerialNo");
					output_17.value = "파일순번";
					...
					var inputBox_5 = new cpr.controls.InputBox("ipbFrfFileSerialNo");
					inputBox_5.visible = false;
					inputBox_5.enabled = false;
					inputBox_5.bind("fieldLabel").toExpression("#optFrfStudId.value");
					inputBox_5.bind("value").toDataMap(app.lookup("dmFrfExtCsrShregAltAply"), "FILE_SERIAL_NO");
					...
					var output_18 = new cpr.controls.Output("optFrfAbsMsg4");
					output_18.value = "";
					output_18.bind("value").toLanguage("UI-SCR-CSRABSAPLYGUID3");
					...
					var output_19 = new cpr.controls.Output("optFrfTempFilePath1");
					output_19.value = "";
					output_19.bind("value").toLanguage("UI-SCR-FILECNT");
					...
					var output_20 = new cpr.controls.Output("optFrfRtnDt");
					output_20.value = "복학예정일자";
					...
					var inputBox_6 = new cpr.controls.InputBox("ipbFrfRtnDt");
					inputBox_6.visible = false;
					inputBox_6.enabled = false;
					inputBox_6.bind("fieldLabel").toExpression("#optFrfStudId.value");
					inputBox_6.bind("value").toDataMap(app.lookup("dmFrfExtCsrShregAltAply"), "RTN_DT");
				...
				userDefinedControl_2.bind("title").toLanguage("UI-SCR-ABSAPL");
				...
				(function(container){
					var output_21 = new cpr.controls.Output("optAddr1");
					output_21.value = "";
					output_21.bind("value").toLanguage("UI-DB-ADDR1");
					...
					var output_22 = new cpr.controls.Output("optZipcode");
					output_22.value = "";
					output_22.bind("value").toLanguage("UI-GLS-ZIPCODE");
					...
					var inputBox_7 = new cpr.controls.InputBox("ipbFrfAddr1");
					inputBox_7.enabled = false;
					inputBox_7.maxLength = 30;
					inputBox_7.bind("fieldLabel").toExpression("#optAddr1.value");
					inputBox_7.bind("value").toDataMap(app.lookup("dmFrfCmnAddr"), "ADDR1");
					...
					var output_23 = new cpr.controls.Output("optClpNo");
					output_23.value = "";
					output_23.bind("value").toLanguage("UI-GLS-CLP");
					...
					var inputBox_8 = new cpr.controls.InputBox("ipbZipSeq");
					inputBox_8.visible = false;
					inputBox_8.maxLength = 50;
					inputBox_8.bind("fieldLabel").toExpression("#optZipSeq.value");
					inputBox_8.bind("value").toDataMap(app.lookup("dmFrfCmnAddr"), "ZIPSEQ");
					...
					var output_24 = new cpr.controls.Output("optAddr2");
					output_24.value = "";
					output_24.bind("value").toLanguage("UI-DB-ADDR2");
					...
					var output_25 = new cpr.controls.Output("optDrtTelNo");
					output_25.value = "";
					output_25.bind("value").toLanguage("UI-DB-HOME_TEL_NO");
					...
					var output_26 = new cpr.controls.Output("optEmail");
					output_26.value = "";
					output_26.bind("value").toLanguage("UI-DB-EMAIL");
					...
					var inputBox_9 = new cpr.controls.InputBox("ipbFrfEmail");
					inputBox_9.maxLength = 100;
					inputBox_9.bind("fieldLabel").toExpression("#optEmail.value");
					inputBox_9.bind("value").toDataMap(app.lookup("dmFrfCmnAddr"), "EMAIL");
					...
					inputBox_10.bind("value").toDataMap(app.lookup("dmFrfCmnAddr"), "FLAG_GBN");
					...
					var inputBox_11 = new cpr.controls.InputBox("ipbFrfUseTabNm");
					inputBox_11.visible = false;
					inputBox_11.bind("value").toDataMap(app.lookup("dmFrfCmnAddr"), "USE_TAB_NM");
					...
					var inputBox_12 = new cpr.controls.InputBox("iipbFrfKeyTabNm");
					inputBox_12.visible = false;
					inputBox_12.bind("value").toDataMap(app.lookup("dmFrfCmnAddr"), "KEY_TAB_NM");
					...
					var inputBox_13 = new cpr.controls.InputBox("ipbFrfZipcode");
					inputBox_13.enabled = false;
					inputBox_13.maxLength = 50;
					inputBox_13.bind("fieldLabel").toExpression("#optZipcode.value");
					inputBox_13.bind("value").toDataMap(app.lookup("dmFrfCmnAddr"), "ZIPCODE");
					...
					var button_3 = new cpr.controls.Button("btnNewPopZipcodeSearch");
					button_3.value = "";
					button_3.style.setClasses(["btn-pop-search"]);
					if(typeof onBtnNewPopZipcodeSearchClick == "function") {
						button_3.addEventListener("click", onBtnNewPopZipcodeSearchClick);
					}
					...
					var output_27 = new cpr.controls.Output("label2");
					output_27.value = "";
					output_27.bind("value").toLanguage("UI-SCR-CSRADDRGUIDMSG2");
					...
					var inputBox_14 = new cpr.controls.InputBox("inputbox1");
					inputBox_14.visible = false;
					inputBox_14.bind("value").toDataMap(app.lookup("dmFrfCmnAddr"), "ST_DT");
					...
					var inputBox_15 = new cpr.controls.InputBox("inputbox2");
					inputBox_15.visible = false;
					inputBox_15.bind("value").toDataMap(app.lookup("dmFrfCmnAddr"), "END_DT");
					...
					var inputBox_16 = new cpr.controls.InputBox("inputbox3");
					inputBox_16.visible = false;
					inputBox_16.bind("value").toDataMap(app.lookup("dmFrfCmnAddr"), "ADDR_PRP_DIV_RCD");
				...
				(function(container){
					var output_28 = new cpr.controls.Output("optAddrGuard1");
					output_28.value = "";
					output_28.bind("value").toLanguage("UI-DB-ADDR1");
					...
					var output_29 = new cpr.controls.Output("optZipcodeGuard");
					output_29.value = "";
					output_29.bind("value").toLanguage("UI-GLS-ZIPCODE");
					...
					var inputBox_17 = new cpr.controls.InputBox("ipbFrfAddrGuard1");
					inputBox_17.enabled = false;
					inputBox_17.maxLength = 30;
					inputBox_17.bind("fieldLabel").toExpression("#optAddrGuard1.value");
					inputBox_17.bind("value").toDataMap(app.lookup("dmFrfCmnAddrGuard"), "ADDR1");
					...
					var output_30 = new cpr.controls.Output("optClpNoGuard");
					output_30.value = "";
					output_30.bind("value").toLanguage("UI-GLS-CLP");
					...
					var inputBox_18 = new cpr.controls.InputBox("ipbZipSeqGuard");
					inputBox_18.visible = false;
					inputBox_18.maxLength = 50;
					inputBox_18.bind("fieldLabel").toExpression("#optZipSeq.value");
					inputBox_18.bind("value").toDataMap(app.lookup("dmFrfCmnAddrGuard"), "ZIPSEQ");
					...
					var output_31 = new cpr.controls.Output("optAddrGuard2");
					output_31.value = "";
					output_31.bind("value").toLanguage("UI-DB-ADDR2");
					...
					var output_32 = new cpr.controls.Output("optDrtTelNoGuard");
					output_32.value = "";
					output_32.bind("value").toLanguage("UI-DB-HOME_TEL_NO");
					...
					var output_33 = new cpr.controls.Output("optCompTelNoGuard");
					output_33.value = "";
					output_33.bind("value").toLanguage("UI-SCR-COMP_TEL_NO");
					...
					var inputBox_19 = new cpr.controls.InputBox("ipbFrfCompTelNoGuard");
					inputBox_19.maxLength = 30;
					inputBox_19.bind("fieldLabel").toExpression("#optCompTelNoGuard.value");
					inputBox_19.bind("value").toDataMap(app.lookup("dmFrfCmnAddrGuard"), "REP_TEL_NO");
					...
					var inputBox_20 = new cpr.controls.InputBox("ipbFrfFlagGbnGuard");
					inputBox_20.visible = false;
					inputBox_20.bind("value").toDataMap(app.lookup("dmFrfCmnAddrGuard"), "FLAG_GBN");
					...
					var inputBox_21 = new cpr.controls.InputBox("ipbFrfUseTabNmGuard");
					inputBox_21.visible = false;
					inputBox_21.bind("value").toDataMap(app.lookup("dmFrfCmnAddrGuard"), "USE_TAB_NM");
					...
					var inputBox_22 = new cpr.controls.InputBox("iipbFrfKeyTabNmGuard");
					inputBox_22.visible = false;
					inputBox_22.bind("value").toDataMap(app.lookup("dmFrfCmnAddrGuard"), "KEY_TAB_NM");
					...
					var inputBox_23 = new cpr.controls.InputBox("ipbFrfZipcodeGuard");
					inputBox_23.enabled = false;
					inputBox_23.maxLength = 50;
					inputBox_23.bind("fieldLabel").toExpression("#optZipcodeGuard.value");
					inputBox_23.bind("value").toDataMap(app.lookup("dmFrfCmnAddrGuard"), "ZIPCODE");
					...
					var button_4 = new cpr.controls.Button("btnNewPopZipcodeSearchGuard");
					button_4.value = "";
					button_4.style.setClasses(["btn-pop-search"]);
					if(typeof onBtnNewPopZipcodeSearchGuardClick == "function") {
						button_4.addEventListener("click", onBtnNewPopZipcodeSearchGuardClick);
					}
					...
					var output_34 = new cpr.controls.Output("label3");
					output_34.value = "";
					output_34.bind("value").toLanguage("UI-SCR-CSRADDRGUIDMSG2");
					...
					var inputBox_24 = new cpr.controls.InputBox("inputbox4");
					inputBox_24.visible = false;
					inputBox_24.bind("value").toDataMap(app.lookup("dmFrfCmnAddrGuard"), "ST_DT");
					...
					var inputBox_25 = new cpr.controls.InputBox("inputbox5");
					inputBox_25.visible = false;
					inputBox_25.bind("value").toDataMap(app.lookup("dmFrfCmnAddrGuard"), "END_DT");
					...
					var inputBox_26 = new cpr.controls.InputBox("inputbox6");
					inputBox_26.visible = false;
					inputBox_26.bind("value").toDataMap(app.lookup("dmFrfCmnAddrGuard"), "ADDR_PRP_DIV_RCD");
				...
				var output_35 = new cpr.controls.Output("optTitle");
				output_35.value = "군휴학신청";
				...
				var button_5 = new cpr.controls.Button("btnCloseCancel");
				button_5.visible = false;
				button_5.value = "";
				button_5.bind("value").toLanguage("UI-SCR-SCRNCLS");
				if(typeof onBtnCloseCancelClick == "function") {
					button_5.addEventListener("click", onBtnCloseCancelClick);
				}
