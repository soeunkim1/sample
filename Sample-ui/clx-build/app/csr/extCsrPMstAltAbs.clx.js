/*
 * App URI: app/csr/extCsrPMstAltAbs
 * Source Location: app/csr/extCsrPMstAltAbs.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/csr/extCsrPMstAltAbs", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "/csr/ExtCsrMstAltAbs/";
			...
			submission_2.action = "/csr/ExtCsrMstAltAbs/";
			...
			submission_3.action = "/csr/ExtCsrMstAltAbs/";
			...
			submission_5.action = "/csr/ExtCsrMstAltAbs/";
			...
			var submission_6 = new cpr.protocols.Submission("subRegTrans");
			submission_6.action = "/csr/ExtCsrMstAltAbs/";
			...
			(function(container){
				...
				(function(container){
					...
					if(typeof onIptFrfAltDtValueChange == "function") {
						dateInput_1.addEventListener("value-change", onIptFrfAltDtValueChange);
					}
					...
					output_5.bind("value").toLanguage("UI-SCR-ABSWHY");
					...
					var output_13 = new cpr.controls.Output("optFrfActDt14");
					output_13.value = "수업일수1/4선";
					...
					var dateInput_6 = new cpr.controls.DateInput("iptFrfActDt14");
					dateInput_6.visible = false;
					dateInput_6.enabled = false;
					dateInput_6.format = "YYYY-MM-DD";
					dateInput_6.bind("fieldLabel").toExpression("#optFrfActDt14.value");
					dateInput_6.bind("value").toDataMap(app.lookup("dmCsrShregAlt"), "ACT_DT14");
