/*
 * App URI: app/csr/extCsrSAbsDtDelayListPrt
 * Source Location: app/csr/extCsrSAbsDtDelayListPrt.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/csr/extCsrSAbsDtDelayListPrt", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "/csr/ExtCsrAbsDtDelayListPrt/";
			submission_1.mediaType = "application/x-www-form-urlencoded";
			submission_1.addResponseData(dataMap_1, false);
			app.register(submission_1);
			
			var submission_2 = new cpr.protocols.Submission("subList");
			submission_2.action = "/csr/ExtCsrAbsDtDelayListPrt/";
			...
			(function(container){
				...
				comboBox_1.bind("value").toDataMap(app.lookup("dmReqList"), "strPrtObjDivRcd");
				(function(comboBox_1){
					comboBox_1.addItem(new cpr.controls.Item("행정부서", "CC009OG"));
					comboBox_1.addItem(new cpr.controls.Item("학사부서", "CC009SA"));
				})(comboBox_1);
	...
	app.title = "extCsrSAbsDtDelayListPrt";
