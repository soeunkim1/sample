/*
 * App URI: app/csr/extCsrSCssInfo
 * Source Location: app/csr/extCsrSCssInfo.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/csr/extCsrSCssInfo", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			var dataSet_3 = new cpr.data.DataSet("dsStudCss");
			dataSet_3.parseData({
			...
			submission_1.action = "/csr/ExtCsrCssInfo/";
			submission_1.mediaType = "application/x-www-form-urlencoded";
			app.register(submission_1);
			
			var submission_2 = new cpr.protocols.Submission("subList");
			submission_2.action = "/csr/ExtCsrCssInfo/";
			...
			(function(container){
				...
				var grid_1 = linker.grid_1 = new cpr.controls.Grid("grdStudCss");
				grid_1.init({
						...
						"cells": [
							...
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										var output_1 = new cpr.controls.Output("gdOptEntScal");
										output_1.dataType = "number";
										output_1.format = "s#,###";
										output_1.style.css({
											"text-align" : "right"
										});
										output_1.bind("value").toDataColumn("ENT_SCAL");
										return output_1;
									})();
								}
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										var output_2 = new cpr.controls.Output("gdOptTutScal");
										output_2.dataType = "number";
										output_2.format = "s#,###";
										output_2.style.css({
											"text-align" : "right"
										});
										output_2.bind("value").toDataColumn("TUT_SCAL");
										return output_2;
									})();
								}
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										var output_3 = new cpr.controls.Output("gdOptEtcScal");
										output_3.dataType = "number";
										output_3.format = "s#,###";
										output_3.style.css({
											"text-align" : "right"
										});
										output_3.bind("value").toDataColumn("ETC_SCAL");
										return output_3;
									})();
								}
							},
