/*
 * App URI: app/csr/extCsrSEntrRemoByProCenter
 * Source Location: app/csr/extCsrSEntrRemoByProCenter.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/csr/extCsrSEntrRemoByProCenter", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "/csr/ExtCsrEntrRemoByProCenter/";
			...
			submission_2.action = "/csr/ExtCsrEntrRemoByProCenter/";
			...
			submission_3.action = "/csr/ExtCsrEntrRemoByProCenter/";
			...
			(function(container){
				...
				var output_7 = new cpr.controls.Output("optAltRsnRcd");
				output_7.value = "제적유형";
				...
				var comboBox_4 = new cpr.controls.ComboBox("cbbAltRsnRcd");
				comboBox_4.bind("fieldLabel").toExpression("#optAltRsnRcd.value");
				comboBox_4.bind("value").toDataMap(app.lookup("dmReqList"), "strAltRsnRcd");
				(function(comboBox_4){
				...
				(function(comboBox_9){
					comboBox_9.addItem(new cpr.controls.Item("입학년도기준탈락자현황", ""));
					comboBox_9.addItem(new cpr.controls.Item("입학년도기준탈락자명단(Excel)", "Y"));
				})(comboBox_9);
	...
	app.title = "extCsrSEntrRemoByProCenter";
