/*
 * App URI: app/csr/extCsrSRemoByProCenter
 * Source Location: app/csr/extCsrSRemoByProCenter.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/csr/extCsrSRemoByProCenter", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "/csr/ExtCsrRemoByProCenter/";
			...
			submission_2.action = "/csr/ExtCsrRemoByProCenter/";
			...
			submission_3.action = "/csr/ExtCsrRemoByProCenter/";
			...
			(function(container){
				...
				(function(comboBox_9){
					comboBox_9.addItem(new cpr.controls.Item("당해년도기준탈락자현황", ""));
					comboBox_9.addItem(new cpr.controls.Item("당해년도기준탈락자명단(Excel)", "Y"));
				})(comboBox_9);
	...
	app.title = "extCsrSRemoByProCenter";
