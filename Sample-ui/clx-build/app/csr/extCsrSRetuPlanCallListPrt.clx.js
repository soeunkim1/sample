/*
 * App URI: app/csr/extCsrSRetuPlanCallListPrt
 * Source Location: app/csr/extCsrSRetuPlanCallListPrt.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/csr/extCsrSRetuPlanCallListPrt", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			var dataSet_3 = new cpr.data.DataSet("dsDayNightList");
			dataSet_3.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"}
			...
			var dataSet_4 = new cpr.data.DataSet("dsRtnRsnList");
			dataSet_4.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"}
			...
			submission_1.action = "/csr/ExtCsrRetuPlanCallListPrt/";
			...
			submission_2.action = "/csr/ExtCsrRetuPlanCallListPrt/";
			...
			submission_3.action = "/csr/ExtCsrRetuPlanCallListPrt/";
			...
			(function(container){
				...
				var output_4 = new cpr.controls.Output("optProcRslt");
				output_4.value = "";
				...
				var output_5 = new cpr.controls.Output("optNight");
				output_5.value = "";
				...
				var numberEditor_1 = new cpr.controls.NumberEditor("ipbProcRslt");
				numberEditor_1.format = "9";
				numberEditor_1.bind("value").toDataMap(app.lookup("dmReqList"), "strProcRslt");
				if(typeof onIpbProcRsltKeydown == "function") {
					numberEditor_1.addEventListener("keydown", onIpbProcRsltKeydown);
				}
				...
				comboBox_3.bind("value").toDataMap(app.lookup("dmReqList"), "strNight");
				(function(comboBox_3){
				...
				var output_6 = new cpr.controls.Output("optPrtGbn");
				output_6.value = "출력용도";
				...
				var radioButton_1 = new cpr.controls.RadioButton("rdbPrtGbn");
				radioButton_1.userAttr({"require": "Y"});
				radioButton_1.bind("fieldLabel").toExpression("#optPrtGbn.value");
				radioButton_1.bind("value").toDataMap(app.lookup("dmReqList"), "strPrtGbn");
				(function(radioButton_1){
					radioButton_1.addItem(new cpr.controls.Item("통화내역", "CALL_INFO"));
					radioButton_1.addItem(new cpr.controls.Item("연락처", "TEL_INFO"));
				})(radioButton_1);
	...
	app.title = "extCsrSRetuPlanCallListPrt";
