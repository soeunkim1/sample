/*
 * App URI: app/csr/extCsrSRetuPlanSaListPrt
 * Source Location: app/csr/extCsrSRetuPlanSaListPrt.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/csr/extCsrSRetuPlanSaListPrt", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "/csr/ExtCsrRetuPlanSaListPrt/";
			...
			submission_2.action = "/csr/ExtCsrRetuPlanSaListPrt/";
			...
			submission_3.action = "/csr/ExtCsrRetuPlanSaListPrt/";
			...
			(function(container){
				...
				var output_6 = new cpr.controls.Output("optObjDivRcd");
				output_6.value = "출력용도";
				...
				var comboBox_4 = new cpr.controls.ComboBox("cbbObjDivRcd");
				comboBox_4.bind("fieldLabel").toExpression("#optChgDivRcd.value");
				comboBox_4.bind("value").toDataMap(app.lookup("dmReqList"), "strPrtObjDivRcd");
				(function(comboBox_4){
					comboBox_4.addItem(new cpr.controls.Item("행정부서", "CC009OG"));
					comboBox_4.addItem(new cpr.controls.Item("학사부서", "CC009SA"));
				})(comboBox_4);
	...
	app.title = "extCsrSRetuPlanSaListPrt";
