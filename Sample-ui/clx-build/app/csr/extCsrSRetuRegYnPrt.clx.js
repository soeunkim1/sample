/*
 * App URI: app/csr/extCsrSRetuRegYnPrt
 * Source Location: app/csr/extCsrSRetuRegYnPrt.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/csr/extCsrSRetuRegYnPrt", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "/csr/ExtCsrRetuRegYnPrt/";
			...
			submission_2.action = "/csr/ExtCsrRetuRegYnPrt/";
			...
			submission_3.action = "/csr/ExtCsrRetuRegYnPrt/";
			...
			(function(container){
				...
				var output_4 = new cpr.controls.Output("optDeptCd1");
				output_4.value = "";
				output_4.style.setClasses(["require"]);
				output_4.bind("value").toLanguage("UI-SCR-REGISTYN");
				...
				var radioButton_1 = new cpr.controls.RadioButton("radiobutton3");
				radioButton_1.bind("value").toDataMap(app.lookup("dmReqList"), "strRegYn");
				...
				var output_5 = new cpr.controls.Output("optObjDivRcd");
				output_5.value = "출력용도";
	...
	app.title = "extCsrSRetuPlanStatPrt";
