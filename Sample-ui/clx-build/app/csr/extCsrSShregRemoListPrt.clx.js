/*
 * App URI: app/csr/extCsrSShregRemoListPrt
 * Source Location: app/csr/extCsrSShregRemoListPrt.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/csr/extCsrSShregRemoListPrt", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "/csr/ExtCsrShregRemoListPrt/";
			...
			submission_2.action = "/csr/ExtCsrShregRemoListPrt/";
			...
			(function(container){
				...
				var output_2 = new cpr.controls.Output("optAltDt");
				output_2.value = "";
				output_2.style.setClasses(["require"]);
				output_2.bind("value").toLanguage("UI-DB-ALT_DT");
				...
				var output_4 = new cpr.controls.Output("optAltEndDt");
				output_4.value = "";
				...
				var output_6 = new cpr.controls.Output("optAltRsnRcd");
				output_6.value = "";
				output_6.bind("value").toLanguage("UI-SCR-CHGRSN");
	...
	app.title = "extCsrSShregRemoListPrt";
