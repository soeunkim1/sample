/*
 * App URI: app/csr/extCsrSStudAddrPrt
 * Source Location: app/csr/extCsrSStudAddrPrt.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/csr/extCsrSStudAddrPrt", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			var dataSet_3 = new cpr.data.DataSet("dsDayNightRcdList");
			dataSet_3.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"}
			...
			submission_1.action = "/csr/ExtCsrStudAddrPrt/";
			...
			submission_2.action = "/csr/ExtCsrStudAddrPrt/";
			...
			(function(container){
				...
				output_1.bind("value").toLanguage("UI-DB-ASGN");
				...
				var output_2 = new cpr.controls.Output("optStatRcd");
				output_2.value = "";
				output_2.bind("value").toLanguage("UI-SCR-SCHREGST");
				...
				comboBox_2.bind("value").toDataMap(app.lookup("dmReqList"), "strProcRlst");
				(function(comboBox_2){
				...
				var output_4 = new cpr.controls.Output("optClassRcd");
				output_4.value = "";
				output_4.bind("value").toLanguage("UI-GLS-CLASSZ");
				...
				var output_5 = new cpr.controls.Output("optDayNightRcd");
				output_5.value = "";
				...
				var comboBox_4 = new cpr.controls.ComboBox("cbbDayNightRcd");
				comboBox_4.bind("fieldLabel").toExpression("#optDayNightRcd.value");
				comboBox_4.bind("value").toDataMap(app.lookup("dmReqList"), "strDayNightRcd");
				(function(comboBox_4){
					comboBox_4.addItem(new cpr.controls.Item("전체", ""));
					comboBox_4.setItemSet(app.lookup("dsDayNightRcdList"), {
						"label": "CD_NM",
						"value": "CD"
					});
				})(comboBox_4);
