/*
 * App URI: app/csr/extCsrSStudListPrt
 * Source Location: app/csr/extCsrSStudListPrt.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/csr/extCsrSStudListPrt", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			// Header
			var dataSet_1 = new cpr.data.DataSet("dsClassRcdList");
			dataSet_1.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"}
			...
			var dataSet_4 = new cpr.data.DataSet("dsNightDivRcdList");
			dataSet_4.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"},
			...
			submission_1.action = "/csr/ExtCsrStudListPrt/";
			...
			submission_2.action = "/csr/ExtCsrStudListPrt/";
			...
			(function(container){
				...
				var output_2 = new cpr.controls.Output("optGenderRcd");
				output_2.value = "";
				...
				var comboBox_1 = new cpr.controls.ComboBox("cbbGenderRcd");
				comboBox_1.bind("fieldLabel").toExpression("#optGenderRcd.value");
				comboBox_1.bind("value").toDataMap(app.lookup("dmReqList"), "strGenderRcd");
				(function(comboBox_1){
				...
				var output_3 = new cpr.controls.Output("optProcRlst");
				output_3.value = "";
				...
				var comboBox_2 = new cpr.controls.ComboBox("cbbProcRlst");
				comboBox_2.bind("fieldLabel").toExpression("#optProcRlst.value");
				...
				var output_4 = new cpr.controls.Output("optNightDivRcd");
				output_4.value = "";
				...
				var comboBox_3 = new cpr.controls.ComboBox("cbbNightDivRcd");
				comboBox_3.bind("fieldLabel").toExpression("#optNightDivRcd.value");
				...
				var output_5 = new cpr.controls.Output("optStatRcd");
				output_5.value = "";
				...
				var output_6 = new cpr.controls.Output("optKeyDate");
				output_6.value = "기준일자";
				...
				var output_7 = new cpr.controls.Output("optObjDivRcd");
				output_7.value = "출력용도";
				...
				var comboBox_5 = new cpr.controls.ComboBox("cbbObjDivRcd");
				comboBox_5.bind("fieldLabel").toExpression("#optChgDivRcd.value");
				comboBox_5.bind("value").toDataMap(app.lookup("dmReqList"), "strPrtObjDivRcd");
				(function(comboBox_5){
					comboBox_5.addItem(new cpr.controls.Item("행정부서", "CC009OG"));
					comboBox_5.addItem(new cpr.controls.Item("학사부서", "CC009SA"));
				})(comboBox_5);
				...
				var output_8 = new cpr.controls.Output("optProcRlst1");
				output_8.value = "반";
