/*
 * App URI: app/csr/stdCsrCAplyYearSmt
 * Source Location: app/csr/stdCsrCAplyYearSmt.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/csr/stdCsrCAplyYearSmt", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "/csr/StdCsrAplyYearSmt/";
			...
			submission_2.action = "/csr/StdCsrAplyYearSmt/";
			...
			(function(container){
				...
				comboBox_1.bind("value").toDataMap(app.lookup("dmYearSmt"), "CD_PRP3");
				(function(comboBox_1){
				...
				comboBox_2.bind("value").toDataMap(app.lookup("dmYearSmt"), "CD_PRP4");
				(function(comboBox_2){
