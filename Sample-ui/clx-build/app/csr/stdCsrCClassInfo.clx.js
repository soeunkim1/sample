/*
 * App URI: app/csr/stdCsrCClassInfo
 * Source Location: app/csr/stdCsrCClassInfo.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/csr/stdCsrCClassInfo", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			var dataSet_2 = new cpr.data.DataSet("dsChgRsnRcdList");
			dataSet_2.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"}
			...
			var dataSet_3 = new cpr.data.DataSet("dsCsrClass");
			dataSet_3.parseData({
			...
			submission_1.action = "/csr/StdCsrClassInfo/";
			...
			submission_2.action = "/csr/StdCsrClassInfo/";
			...
			submission_3.action = "/csr/StdCsrClassInfo/";
			...
			// UI Configuration
			var group_1 = new cpr.controls.Container("grp_rptCsrClass");
			// Layout
			var xYLayout_2 = new cpr.controls.layouts.XYLayout();
			group_1.setLayout(xYLayout_2);
			(function(container){
				var userDefinedControl_1 = linker.userDefinedControl_1 = new udc.com.comTitle();
				userDefinedControl_1.bind("title").toLanguage("UI-SCR-CLASSINFO");
				...
				var grid_1 = linker.grid_1 = new cpr.controls.Grid("grdCsrClass");
				grid_1.init({
					"dataSet": app.lookup("dsCsrClass"),
					"columns": [
						{"width": "25px"},
						{"width": "40px"},
						{"width": "70px"},
						...
						"cells": [
							...
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										var comboBox_1 = new cpr.controls.ComboBox("gdCbbClassRcd");
										...
										(function(comboBox_1){
											...
											comboBox_1.setItemSet(app.lookup("dsClassRcdList"), {
												"label": "CD_NM",
												"value": "CD"
											});
										})(comboBox_1);
										comboBox_1.bind("value").toDataColumn("CLASS_RCD");
										return comboBox_1;
									})();
								}
							},
							...
							},
							{
								"constraint": {"rowIndex": 0, "colIndex": 5},
								"configurator": function(cell){
									cell.columnName = "CHG_RSN_RCD";
									cell.control = (function(){
										var comboBox_2 = new cpr.controls.ComboBox("gdCbbChgRsnRcd");
										(function(comboBox_2){
											comboBox_2.setItemSet(app.lookup("dsChgRsnRcdList"), {
												"label": "CD_NM",
												"value": "CD"
											});
										})(comboBox_2);
										comboBox_2.bind("value").toDataColumn("CHG_RSN_RCD");
										return comboBox_2;
									})();
								}
							},
