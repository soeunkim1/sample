/*
 * App URI: app/csr/stdCsrCMstAddrWorld
 * Source Location: app/csr/stdCsrCMstAddrWorld.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/csr/stdCsrCMstAddrWorld", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			var dataSet_5 = new cpr.data.DataSet("dsNationList");
			dataSet_5.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"}
			...
			submission_1.action = "/csr/StdCsrMstAddrWorld/";
			...
			submission_2.action = "/csr/StdCsrMstAddrWorld/";
			...
			submission_3.action = "/csr/StdCsrMstAddrWorld/";
			...
			(function(container){
				...
				(function(container){
					...
					output_5.value = "";
					output_5.bind("value").toLanguage("UI-GLS-CLP");
					...
					var numberEditor_4 = new cpr.controls.NumberEditor("ipbFrfAen");
					numberEditor_4.format = "9,999,999,999";
					numberEditor_4.bind("fieldLabel").toExpression("#optAen.value");
					numberEditor_4.bind("value").toDataColumn("AEN");
					...
					var numberEditor_5 = new cpr.controls.NumberEditor("ipbFrfRepTelNo");
					numberEditor_5.format = "999,999,999,999,999,999,999,999,999,999";
					numberEditor_5.bind("fieldLabel").toExpression("#optRepTelNo.value");
					numberEditor_5.bind("value").toDataColumn("REP_TEL_NO");
					...
					var output_14 = new cpr.controls.Output("optMessenger1");
					output_14.value = "";
					output_14.bind("value").toLanguage("UI-GLS-MESSAEGER");
					...
					var output_15 = new cpr.controls.Output("optRemark");
					output_15.value = "";
					...
					var output_16 = new cpr.controls.Output("optRgn");
					output_16.value = "";
					output_16.bind("value").toLanguage("UI-DB-RGN");
					...
					var output_17 = new cpr.controls.Output("label1");
					output_17.value = "";
					...
					var output_18 = new cpr.controls.Output("optFrfEndDt");
					output_18.value = "";
					output_18.dataType = "date";
					output_18.format = "YYYY-MM-DD";
					output_18.bind("value").toDataColumn("END_DT");
					...
					var output_19 = new cpr.controls.Output("optFrfStDt");
					output_19.value = "";
					...
					var output_20 = new cpr.controls.Output("label2");
					output_20.value = "";
					output_20.bind("value").toLanguage("UI-SCR-CSRADDRGUIDMSG1");
					...
					var output_21 = new cpr.controls.Output("optNatRcd");
					output_21.value = "";
					output_21.style.setClasses(["require"]);
					output_21.bind("value").toLanguage("UI-DB-NAT_RCD");
					...
					var output_22 = new cpr.controls.Output("optCityNm");
					output_22.value = "";
					output_22.bind("value").toLanguage("UI-DB-CITY_NM");
					...
					var inputBox_12 = new cpr.controls.InputBox("ipbFrfCityNm");
					inputBox_12.maxLength = 100;
					inputBox_12.bind("fieldLabel").toExpression("#optRgn.value");
					inputBox_12.bind("value").toDataColumn("CITY_NM");
					...
					var comboBox_2 = new cpr.controls.ComboBox("cbbFrfNatRcd");
					comboBox_2.userAttr({"require": "Y"});
					comboBox_2.bind("fieldLabel").toExpression("#optNatRcd.value");
					comboBox_2.bind("value").toDataColumn("NAT_RCD");
					(function(comboBox_2){
						comboBox_2.setItemSet(app.lookup("dsNationList"), {
							"label": "CD_NM",
							"value": "CD"
						});
					})(comboBox_2);
						...
						"cells": [
							...
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										var comboBox_3 = new cpr.controls.ComboBox("gdAddrPrpDivRcd");
										...
										comboBox_3.bind("value").toDataColumn("ADDR_PRP_DIV_RCD");
										return comboBox_3;
									})();
								}
							},
							...
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										var comboBox_4 = new cpr.controls.ComboBox("rhCbbNatRcd");
				...
				var output_26 = new cpr.controls.Output("optStdDt");
				output_26.value = "";
			...
			(function(container){
				var output_27 = new cpr.controls.Output("optAddrPrpDivRcd1");
				output_27.value = "";
				output_27.bind("value").toLanguage("UI-SCR-ADDRUSENM");
				...
				var comboBox_5 = new cpr.controls.ComboBox("cbbSchAddrPrpDivRcd");
				comboBox_5.bind("fieldLabel").toExpression("#optAddrPrpDivRcd.value");
				comboBox_5.bind("value").toDataMap(app.lookup("dmReqList"), "strPrpDivRcd");
				(function(comboBox_5){
					comboBox_5.addItem(new cpr.controls.Item("전체", ""));
					comboBox_5.setItemSet(app.lookup("dsAddrList"), {
						"label": "CD_NM",
						"value": "CD"
					});
				})(comboBox_5);
