/*
 * App URI: app/csr/stdCsrPCnlAltReEn
 * Source Location: app/csr/stdCsrPCnlAltReEn.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/csr/stdCsrPCnlAltReEn", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "/csr/StdCsrCnlAltReEn/";
			...
			submission_2.action = "/csr/StdCsrCnlAltReEn/";
			...
			(function(container){
				...
				(function(container){
					...
					var output_13 = new cpr.controls.Output("optFrfSchYearNmRe");
					output_13.value = "";
					output_13.bind("value").toDataMap(app.lookup("dmCsrShregAltRe"), "SCH_YEAR_NM");
					...
					var output_14 = new cpr.controls.Output("optFrfAltRsnNmRe");
					output_14.value = "";
					output_14.bind("value").toDataMap(app.lookup("dmCsrShregAltRe"), "ALT_RSN_NM");
					...
					var output_15 = new cpr.controls.Output("optFrfSmtNmRe");
					output_15.value = "";
					output_15.bind("value").toDataMap(app.lookup("dmCsrShregAltRe"), "SMT_NM");
					...
					var output_16 = new cpr.controls.Output("optFrfAltDtRe");
					output_16.value = "";
					output_16.dataType = "date";
					output_16.format = "YYYY-MM-DD";
					output_16.bind("value").toDataMap(app.lookup("dmCsrShregAltRe"), "ALT_DT");
					...
					var output_17 = new cpr.controls.Output("optFrfCancelRsnRcd");
					output_17.value = "";
					output_17.style.setClasses(["require"]);
					output_17.bind("value").toLanguage("UI-SCR-CANCLWHY");
					...
					comboBox_1.bind("value").toDataMap(app.lookup("dmCsrShregAltRe"), "CANCEL_RSN_RCD");
					(function(comboBox_1){
					...
					var output_18 = new cpr.controls.Output("optFrfCancelDt");
					output_18.value = "";
					output_18.style.setClasses(["require"]);
					output_18.bind("value").toLanguage("UI-DB-CANCEL_DT");
					...
					dateInput_1.bind("value").toDataMap(app.lookup("dmCsrShregAltRe"), "CANCEL_DT");
				...
				(function(container){
					var output_19 = new cpr.controls.Output("optFrfEnrollDivRcdEnr");
					output_19.value = "";
					output_19.bind("value").toLanguage("UI-SCR-SCREGDIV");
					...
					var output_20 = new cpr.controls.Output("optFrfStDtEnr");
					output_20.value = "";
					output_20.bind("value").toLanguage("UI-SCR-EFETSTDT");
					...
					var output_21 = new cpr.controls.Output("optFrfSpDivRcdEnr");
					output_21.value = "";
					output_21.bind("value").toLanguage("UI-SCR-SPCORSDIV");
					...
					var output_22 = new cpr.controls.Output("optFrfSaCdEnr");
					output_22.value = "";
					output_22.bind("value").toLanguage("UI-GLS-SA");
					...
					var output_23 = new cpr.controls.Output("optFrfOgCdEnr");
					output_23.value = "";
					output_23.bind("value").toLanguage("UI-GLS-OG");
					...
					var output_24 = new cpr.controls.Output("optFrfEndDtEnr");
					output_24.value = "";
					output_24.bind("value").toLanguage("UI-SCR-EFETEDDT");
					...
					var output_25 = new cpr.controls.Output("optFrfEnrollRsnRcdEnr");
					output_25.value = "";
					output_25.bind("value").toLanguage("UI-SCR-SCHREGRSN");
					...
					var output_26 = new cpr.controls.Output("optFrfSpCdEnr");
					output_26.value = "";
					output_26.bind("value").toLanguage("UI-GLS-SP");
					...
					var output_27 = new cpr.controls.Output("optFrfCurAplyYearRcdEnr");
					output_27.value = "";
					output_27.bind("value").toLanguage("UI-SCR-SUBPROGRDYRS");
					...
					var output_28 = new cpr.controls.Output("optFrfEnrollDivNmEnr");
					output_28.value = "";
					output_28.bind("value").toDataMap(app.lookup("dmCsrEnroll"), "ENROLL_DIV_NM");
					...
					var output_29 = new cpr.controls.Output("optFrfSaNmEnr");
					output_29.value = "";
					output_29.bind("value").toDataMap(app.lookup("dmCsrEnroll"), "SA_NM");
					...
					var output_30 = new cpr.controls.Output("optFrfEnrollRsnNmEnr");
					output_30.value = "";
					output_30.bind("value").toDataMap(app.lookup("dmCsrEnroll"), "ENROLL_RSN_NM");
					...
					var output_31 = new cpr.controls.Output("optFrfStDtEnr");
					output_31.value = "";
					output_31.dataType = "date";
					output_31.format = "YYYY-MM-DD";
					output_31.bind("value").toDataMap(app.lookup("dmCsrEnroll"), "ST_DT");
					...
					var output_32 = new cpr.controls.Output("optOgNmEnr");
					output_32.value = "";
					output_32.bind("value").toDataMap(app.lookup("dmCsrEnroll"), "OG_NM");
					...
					var output_33 = new cpr.controls.Output("optFrfSpDivNmEnr");
					output_33.value = "";
					output_33.bind("value").toDataMap(app.lookup("dmCsrEnroll"), "SP_DIV_NM");
					...
					var output_34 = new cpr.controls.Output("optFrfSpNmEnr");
					output_34.value = "";
					output_34.bind("value").toDataMap(app.lookup("dmCsrEnroll"), "SP_NM");
					...
					var output_35 = new cpr.controls.Output("optFrfCurAplyYearNmEnr");
					output_35.value = "";
					output_35.bind("value").toDataMap(app.lookup("dmCsrEnroll"), "CUR_APLY_YEAR_NM");
					...
					var output_36 = new cpr.controls.Output("optFrfEndDtEnr");
					output_36.value = "";
					output_36.dataType = "date";
					output_36.format = "YYYY-MM-DD";
					output_36.bind("value").toDataMap(app.lookup("dmCsrEnroll"), "END_DT");
				...
				(function(container){
					var output_37 = new cpr.controls.Output("optCourse");
					output_37.value = "";
					output_37.bind("value").toLanguage("UI-GLS-CRS");
					...
					var output_38 = new cpr.controls.Output("optCourse");
					output_38.value = "";
					output_38.bind("value").toDataMap(app.lookup("dmReqKey"), "strHeaderCourse");
					...
					var output_39 = new cpr.controls.Output("optStud");
					output_39.value = "";
					output_39.bind("value").toDataMap(app.lookup("dmReqKey"), "strStudInfo");
					...
					var output_40 = new cpr.controls.Output("optStudNm");
					output_40.value = "";
					output_40.bind("value").toLanguage("UI-GLS-PER_NM");
					...
					var output_41 = new cpr.controls.Output("optStudNo");
					output_41.value = "";
					output_41.bind("value").toLanguage("UI-GLS-STUD_ID");
					...
					var output_42 = new cpr.controls.Output("optStudNo");
					output_42.value = "";
					output_42.bind("value").toDataMap(app.lookup("dmReqKey"), "strStudNo");
