/*
 * App URI: app/csr/stdCsrPMstAltWith
 * Source Location: app/csr/stdCsrPMstAltWith.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/csr/stdCsrPMstAltWith", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			// Header
			var dataSet_1 = new cpr.data.DataSet("dsReasonList");
			dataSet_1.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"}
			...
			var dataSet_2 = new cpr.data.DataSet("dsRefundBankRcdList");
			dataSet_2.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"}
			...
			var dataSet_3 = new cpr.data.DataSet("dsRefundRateRcdList");
			dataSet_3.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"}
			...
			var dataSet_4 = new cpr.data.DataSet("dsSchYearList");
			dataSet_4.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"}
			...
			var dataSet_5 = new cpr.data.DataSet("dsSmtList");
			dataSet_5.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"}
			...
			submission_1.action = "/csr/StdCsrMstAltWith/";
			...
			submission_2.action = "/csr/StdCsrMstAltWith/";
			...
			(function(container){
				...
				(function(container){
					...
					dateInput_2.bind("value").toDataMap(app.lookup("dmCsrShregAlt"), "ALT_DT");
					...
					var inputBox_4 = new cpr.controls.InputBox("ipbFrfRefundRateRcd");
					inputBox_4.visible = false;
					inputBox_4.enabled = false;
					inputBox_4.readOnly = true;
					inputBox_4.maxLength = 100;
					inputBox_4.bind("fieldLabel").toExpression("#optFrfRefundRateRcd.value");
					inputBox_4.bind("value").toDataMap(app.lookup("dmCsrShregAlt"), "REFUND_RATE_RCD");
					...
					var numberEditor_1 = new cpr.controls.NumberEditor("ipbFrfRefundAmt");
					numberEditor_1.visible = false;
					numberEditor_1.enabled = false;
					numberEditor_1.format = "999,990";
					numberEditor_1.bind("fieldLabel").toExpression("#optFrfRefundAmt.value");
					numberEditor_1.bind("value").toDataMap(app.lookup("dmCsrShregAlt"), "REFUND_AMT");
					...
					var output_9 = new cpr.controls.Output("optFrfRefundAmt1");
					output_9.value = "";
					...
					var output_10 = new cpr.controls.Output("optFrfRefundRateRcd1");
					output_10.value = "";
					output_10.bind("value").toLanguage("UI-SCR-RTRNWHY");
					...
					var inputBox_5 = new cpr.controls.InputBox("ipbFrfRefundAcctHld");
					inputBox_5.maxLength = 100;
					inputBox_5.bind("fieldLabel").toExpression("#optFrfRefundAcctHld.value");
					inputBox_5.bind("value").toDataMap(app.lookup("dmCsrShregAlt"), "REFUND_ACCT_HLD");
					...
					var output_11 = new cpr.controls.Output("optFrfRefundAcctHld1");
					output_11.value = "";
					output_11.bind("value").toLanguage("UI-SCR-RTRNWHY");
					...
					var inputBox_6 = new cpr.controls.InputBox("ipbFrfRefundAcctNo");
					inputBox_6.maxLength = 100;
					inputBox_6.bind("fieldLabel").toExpression("#optFrfRefundAcctNo.value");
					inputBox_6.bind("value").toDataMap(app.lookup("dmCsrShregAlt"), "REFUND_ACCT_NO");
					...
					var output_12 = new cpr.controls.Output("optFrfRefundAcctNo1");
					output_12.value = "";
					output_12.bind("value").toLanguage("UI-SCR-REFUNDACCTNO");
					...
					var output_13 = new cpr.controls.Output("optFrfRefundBankCd1");
					output_13.value = "";
					output_13.bind("value").toLanguage("UI-SCR-REFUNDBANK");
				...
				(function(container){
					...
					output_14.value = "";
					output_14.bind("value").toLanguage("UI-GLS-CRS");
					...
					output_15.value = "";
					output_15.bind("value").toDataMap(app.lookup("dmReqKey"), "strHeaderCourse");
					...
					var output_16 = new cpr.controls.Output("optStud");
					output_16.value = "";
					output_16.bind("value").toDataMap(app.lookup("dmReqKey"), "strStudInfo");
					...
					var output_17 = new cpr.controls.Output("optStudNm");
					output_17.value = "";
					output_17.bind("value").toLanguage("UI-GLS-PER_NM");
					...
					output_18.value = "";
					output_18.bind("value").toLanguage("UI-GLS-STUD_ID");
					...
					output_19.value = "";
					output_19.bind("value").toDataMap(app.lookup("dmReqKey"), "strStudNo");
