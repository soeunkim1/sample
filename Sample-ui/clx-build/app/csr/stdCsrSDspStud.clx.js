/*
 * App URI: app/csr/stdCsrSDspStud
 * Source Location: app/csr/stdCsrSDspStud.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/csr/stdCsrSDspStud", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			var dataSet_2 = new cpr.data.DataSet("dsStSchYearList");
			dataSet_2.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"},
			...
			var dataSet_3 = new cpr.data.DataSet("dsStSmtList");
			dataSet_3.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"}
			...
			var dataSet_4 = new cpr.data.DataSet("dsExhDivList");
			dataSet_4.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"}
			...
			var dataSet_5 = new cpr.data.DataSet("dsExhStatList");
			dataSet_5.parseData({
				"columns": [
					{"name": "CD"},
					{"name": "CD_NM"}
			...
			var dataMap_2 = new cpr.data.DataMap("dmCsrDspExhStud");
			dataMap_2.parseData({
				"columns" : [
					{
						"name": "STUD_ID",
			...
			submission_1.action = "/csr/StdCsrDspStud/";
			...
			submission_5.action = "/csr/StdCsrDspStud/";
			...
			submission_6.action = "/csr/StdCsrDspStud/";
			...
			(function(container){
				var group_2 = new cpr.controls.Container("frfCsrDspExhStud");
				group_2.style.setClasses(["form-box"]);
				// Layout
				var xYLayout_3 = new cpr.controls.layouts.XYLayout();
				group_2.setLayout(xYLayout_3);
				(function(container){
					var output_1 = new cpr.controls.Output("optFrfStSchYearRcd");
					output_1.value = "";
					...
					var comboBox_1 = new cpr.controls.ComboBox("cbbFrfStSchYearRcd");
					comboBox_1.bind("fieldLabel").toExpression("#optFrfStSchYearRcd.value");
					comboBox_1.bind("value").toDataMap(app.lookup("dmCsrDspExhStud"), "ST_SCH_YEAR_RCD");
					(function(comboBox_1){
						comboBox_1.setItemSet(app.lookup("dsStSchYearList"), {
							"label": "CD_NM",
							"value": "CD"
						});
					})(comboBox_1);
					if(typeof onCbbFrfStSchYearRcdSelectionChange == "function") {
						comboBox_1.addEventListener("selection-change", onCbbFrfStSchYearRcdSelectionChange);
					}
					...
					inputBox_1.bind("value").toDataMap(app.lookup("dmCsrDspExhStud"), "STUD_ID");
					...
					comboBox_2.bind("value").toDataMap(app.lookup("dmCsrDspExhStud"), "CAT_RCD");
					(function(comboBox_2){
					...
					dateInput_1.bind("value").toDataMap(app.lookup("dmCsrDspExhStud"), "ST_DT");
					...
					var output_4 = new cpr.controls.Output("optFrfStSmtRcd");
					output_4.value = "";
					output_4.bind("value").toLanguage("UI-SCR-STSMT");
					...
					var comboBox_3 = new cpr.controls.ComboBox("cbbFrfStSmtRcd");
					comboBox_3.bind("fieldLabel").toExpression("#optFrfStSmtRcd.value");
					comboBox_3.bind("value").toDataMap(app.lookup("dmCsrDspExhStud"), "ST_SMT_RCD");
					(function(comboBox_3){
						comboBox_3.setItemSet(app.lookup("dsStSmtList"), {
							"label": "CD_NM",
							"value": "CD"
						});
					})(comboBox_3);
					if(typeof onCbbFrfStSmtRcdSelectionChange == "function") {
						comboBox_3.addEventListener("selection-change", onCbbFrfStSmtRcdSelectionChange);
					}
					...
					var output_5 = new cpr.controls.Output("optFrfEndSchYearRcd");
					output_5.value = "";
					output_5.bind("value").toLanguage("UI-SCR-ENDYEAR");
					...
					var comboBox_4 = new cpr.controls.ComboBox("cbbFrfEndSchYearRcd");
					comboBox_4.bind("fieldLabel").toExpression("#optFrfEndSchYearRcd.value");
					comboBox_4.bind("value").toDataMap(app.lookup("dmCsrDspExhStud"), "END_SCH_YEAR_RCD");
					(function(comboBox_4){
						comboBox_4.setItemSet(app.lookup("dsStSchYearList"), {
							"label": "CD_NM",
							"value": "CD"
						});
					})(comboBox_4);
					if(typeof onCbbFrfEndSchYearRcdSelectionChange == "function") {
						comboBox_4.addEventListener("selection-change", onCbbFrfEndSchYearRcdSelectionChange);
					}
					...
					var output_6 = new cpr.controls.Output("optFrfEndSmtRcd");
					output_6.value = "";
					output_6.bind("value").toLanguage("UI-SCR-ENDSMT");
					...
					var comboBox_5 = new cpr.controls.ComboBox("cbbFrfEndSmtRcd");
					comboBox_5.bind("fieldLabel").toExpression("#optFrfEndSmtRcd.value");
					comboBox_5.bind("value").toDataMap(app.lookup("dmCsrDspExhStud"), "END_SMT_RCD");
					(function(comboBox_5){
						comboBox_5.setItemSet(app.lookup("dsStSmtList"), {
							"label": "CD_NM",
							"value": "CD"
						});
					})(comboBox_5);
					if(typeof onCbbFrfEndSmtRcdSelectionChange == "function") {
						comboBox_5.addEventListener("selection-change", onCbbFrfEndSmtRcdSelectionChange);
					}
					...
					var output_7 = new cpr.controls.Output("optFrfEndDt");
					output_7.value = "";
					...
					dateInput_2.bind("value").toDataMap(app.lookup("dmCsrDspExhStud"), "END_DT");
					...
					output_8.value = "";
					output_8.bind("value").toLanguage("UI-DB-EXH_STUD_DESC");
					...
					inputBox_2.bind("value").toDataMap(app.lookup("dmCsrDspExhStud"), "EXH_STUD_DESC");
					...
					var output_9 = new cpr.controls.Output("optFrfOtNm");
					output_9.value = "";
					output_9.style.setClasses(["require"]);
					output_9.bind("value").toLanguage("UI-SCR-VISITSCH");
					...
					inputBox_3.bind("value").toDataMap(app.lookup("dmCsrDspExhStud"), "OT_NM");
					...
					inputBox_4.bind("value").toDataMap(app.lookup("dmCsrDspExhStud"), "OT_CD");
					...
					var output_10 = new cpr.controls.Output("optFrfExhPgmNm");
					output_10.value = "";
					output_10.style.setClasses(["require"]);
					output_10.bind("value").toLanguage("UI-DB-EXH_PGM_NM");
					...
					inputBox_5.bind("value").toDataMap(app.lookup("dmCsrDspExhStud"), "EXH_PGM_NM");
					...
					inputBox_6.bind("value").toDataMap(app.lookup("dmCsrDspExhStud"), "EXH_PGM_CD");
					...
					var output_11 = new cpr.controls.Output("optFrfExhStudStatRcd");
					output_11.value = "";
					output_11.bind("value").toLanguage("UI-DB-EXH_STUD_STAT_RCD");
					...
					var comboBox_6 = new cpr.controls.ComboBox("cbbFrfExhStudStatRcd");
					comboBox_6.bind("fieldLabel").toExpression("#optFrfExhStudStatRcd.value");
					comboBox_6.bind("value").toDataMap(app.lookup("dmCsrDspExhStud"), "EXH_STUD_STAT_RCD");
					(function(comboBox_6){
						comboBox_6.setItemSet(app.lookup("dsExhStatList"), {
							"label": "CD_NM",
							"value": "CD"
						});
					})(comboBox_6);
					...
					inputBox_7.bind("value").toDataMap(app.lookup("dmCsrDspExhStud"), "REF_KEY");
