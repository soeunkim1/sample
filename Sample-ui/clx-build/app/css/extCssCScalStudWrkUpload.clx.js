/*
 * App URI: app/css/extCssCScalStudWrkUpload
 * Source Location: app/css/extCssCScalStudWrkUpload.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/css/extCssCScalStudWrkUpload", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			var dataMap_2 = new cpr.data.DataMap("dmResCheck");
			dataMap_2.parseData({
				"columns" : [{
					"name": "intCheck",
					"dataType": "string"
			...
			submission_1.action = "/css/ExtCssScalStudWrkUpload/";
			...
			submission_2.action = "/css/ExtCssScalStudWrkUpload/";
			...
			submission_3.action = "/css/ExtCssScalStudWrkUpload/";
			...
			submission_4.action = "/css/ExtCssScalStudWrkUpload/";
			...
			(function(container){
				...
				var output_4 = new cpr.controls.Output("optWrkYyMm");
				output_4.value = "";
				output_4.style.setClasses(["require"]);
				output_4.bind("value").toLanguage("UI-SCR-WRKYEARMM");
				...
				var dateInput_1 = new cpr.controls.DateInput("dipWrkYyMm");
				dateInput_1.format = "YYYY-MM";
				dateInput_1.userAttr({"require": "Y"});
				dateInput_1.style.css({
					"text-align" : "center"
				});
				dateInput_1.bind("fieldLabel").toExpression("#optWrkYyMm.value");
				dateInput_1.bind("value").toDataMap(app.lookup("dmReqKey"), "strWrkYyMon");
