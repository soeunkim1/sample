/*
 * App URI: app/css/extCssSStudScalList
 * Source Location: app/css/extCssSStudScalList.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/css/extCssSStudScalList", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			// Header
			var dataSet_1 = new cpr.data.DataSet("dsStudScal");
			dataSet_1.parseData({
			...
			submission_1.action = "/css/ExtCssStudScalList/";
			submission_1.mediaType = "application/x-www-form-urlencoded";
			submission_1.addResponseData(dataMap_2, false);
			app.register(submission_1);
			
			var submission_2 = new cpr.protocols.Submission("subList");
			submission_2.action = "/css/ExtCssStudScalList/";
			...
			(function(container){
				...
				userDefinedControl_2.bind("title").toLanguage("UI-SCR-SCRSBFRCLST");
					...
					"header": {
						...
						"cells": [
							...
							},
							{
								...
								"configurator": function(cell){
									cell.bind("text").toLanguage("UI-SCR-ENTSCALFEE");
								}
							},
							{
								"constraint": {"rowIndex": 0, "colIndex": 6},
								"configurator": function(cell){
									cell.bind("text").toLanguage("UI-SCR-TUTSCALFEE");
								}
							},
							{
								"constraint": {"rowIndex": 0, "colIndex": 7},
								"configurator": function(cell){
									cell.bind("text").toLanguage("UI-SCR-ETCSCALFEE");
								}
							},
							{
								"constraint": {"rowIndex": 0, "colIndex": 8},
								"configurator": function(cell){
									cell.bind("text").toLanguage("UI-SCR-SCALAGENCY");
								}
							}
						]
					},
						...
						"cells": [
							...
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										var output_2 = new cpr.controls.Output("gdOptEntScal");
										output_2.dataType = "number";
										output_2.format = "s#,###";
										output_2.style.css({
											"text-align" : "right"
										});
										output_2.bind("value").toDataColumn("ENT_SCAL");
										return output_2;
									})();
								}
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										var output_3 = new cpr.controls.Output("gdOptTutScal");
										output_3.dataType = "number";
										output_3.format = "s#,###";
										output_3.style.css({
											"text-align" : "right"
										});
										output_3.bind("value").toDataColumn("TUT_SCAL");
										return output_3;
									})();
								}
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										var output_4 = new cpr.controls.Output("gdOptEtcScal");
										output_4.dataType = "number";
										output_4.format = "s#,###";
										output_4.style.css({
											"text-align" : "right"
										});
										output_4.bind("value").toDataColumn("ETC_SCAL");
										return output_4;
									})();
								}
							},
