/*
 * App URI: app/css/stdCssCScalStudRcc
 * Source Location: app/css/stdCssCScalStudRcc.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/css/stdCssCScalStudRcc", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			var dataSet_4 = new cpr.data.DataSet("dsScalStudRcc");
			dataSet_4.parseData({
			...
			submission_1.action = "/css/StdCssScalStudRcc/";
			...
			submission_2.action = "/css/StdCssScalStudRcc/";
			...
			submission_3.action = "/css/StdCssScalStudRcc/";
			...
			(function(container){
				...
				userDefinedControl_1.bind("title").toLanguage("UI-SCR-SCRSRCC");
				...
				var grid_1 = linker.grid_1 = new cpr.controls.Grid("grdScalStudRcc");
				grid_1.init({
					"dataSet": app.lookup("dsScalStudRcc"),
					"columns": [
						{"width": "25px"},
						{"width": "40px"},
						{"width": "20px"},
					...
					"header": {
						...
						"cells": [
							...
							},
							{
								...
								"configurator": function(cell){
									cell.style.setClasses(["require"]);
									cell.bind("text").toLanguage("UI-SCR-RCCAMT");
								}
							},
							{
			...
			var embeddedApp_3 = new cpr.controls.EmbeddedApp("emaDialogScalFeePmnt");
			cpr.core.App.load("app/css/impDialogScalFee", function(app) {
				if(app){
