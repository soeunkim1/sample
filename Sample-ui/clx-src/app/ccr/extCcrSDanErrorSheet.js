...
/// <xtmlink path="./extCcrSDanErrorSheet.xtm"/>

/**
 * 주야구분신청 오류자명단
 * @class extCcrSDanErrorSheet
 * @author 유형기 at 2016. 6. 28
 */
var extCcrSDanErrorSheet = function() {
	var moPage = new Page();
	 ...
	 * @author 유형기 at 2016. 6. 28
	 */
	moPage.onModelConstructDone_ExtCcrSDanErrorSheet = function() {
		// 검색조건 초기 설정
	...
	moPage.onClick_BtnSearch = function() {
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				var vsTitle = vsSchYearRcdNm + " " + vsSmtRcdNm + " 주야구분신청 오류자명단";
				...
				util.Report.open(app, "hojReport", "extCcrSDanErrorSheet", voOzFormParam, voParam);
