...
/// <xtmlink path="./extCcrSMandUnTlsnReqList.xtm"/>

/**
 * 필수과목미신청자명단
 * @class extCcrSMandUnTlsnReqList
 * @author 유형기 at 2016. 6. 28
 */
var extCcrSMandUnTlsnReqList = function() {
	var moPage = new Page();
	 ...
	 * @author 유형기 at 2016. 6. 28
	 */
	moPage.onModelConstructDone_ExtCcrSMandUnTlsnReqList = function() {
		// 검색조건 초기 설정
	...
	moPage.onClick_BtnSearch = function() {
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				var vsTitle = "필수과목 미 신청자(유보자 제외) 명단";
				...
				util.Report.open(app, "hojReport", "extCcrSMandUnTlsnReqList", voOzFormParam, voParam);
			}
		});
