...
/// <xtmlink path="./extCcrSNotStudList.xtm"/>

/**
 * 미수강신청자명단
 * @class extCcrSNotStudList
 * @author 박갑수 at 2016. 6. 24
 */
var extCcrSNotStudList = function() {
	var moPage = new Page();
	 ...
	 * @author 박갑수 at 2016. 6. 24
	 */
	moPage.onModelConstructDone_ExtCcrSNotStudList = function() {
		// 검색조건 초기 설정
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				var voParam = {
						...
						p_strNewStud		: util.Control.getValue(app, "ckbNewStud")								// 신입생조회
				};
				...
				var vsTitle = vsSchYearRcdNm + " " + vsSmtRcdNm + " 미수강 신청자 명단";
				...
				util.Report.open(app, "hojReport", "extCcrSNotStudList", voOzFormParam, voParam);
