...
/// <xtmlink path="./extCcrSOtherDptmjTlsnList.xtm"/>

/**
 * 타과수강자명단
 * @class extCcrSOtherDptmjTlsnList
 * @author 박갑수 at 2016. 6. 24
 */
var extCcrSOtherDptmjTlsnList = function() {
	var moPage = new Page();
	 ...
	 * @author 박갑수 at 2016. 6. 24
	 */
	moPage.onModelConstructDone_ExtCcrSOtherDptmjTlsnList = function() {
		// 검색조건 초기 설정
	...
	moPage.onClick_BtnSearch = function() {
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				var vsTitle = vsSchYearRcdNm + " " + vsSmtRcdNm + " 타과 수강자 명단 LIST";
				...
				util.Report.open(app, "hojReport", "extCcrSOtherDptmjTlsnList", voOzFormParam, voParam);
			}
		});
