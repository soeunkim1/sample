...
/// <xtmlink path="./extCcrSReTlsnPsn.xtm"/>
	...
	moPage.onClick_BtnSearch = function() {
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				var vsTitle = vsSchYearRcdNm + " " + vsSmtRcdNm + " 재수강자 명단";
				...
				util.Report.open(app, "hojReport", "extCcrSReTlsnPsn", voOzFormParam, voParam);
			}
		});
