...
/// <xtmlink path="./extCcrSSbTlsnReqCntList.xtm"/>

/**
 * 과목별 수강신청 현황(합강)
 * @class extCcrSSbTlsnReqCntList
 * @author 유형기 at 2016. 6. 28
 */
var extCcrSSbTlsnReqCntList = function() {
	var moPage = new Page();
	 ...
	 * @author 유형기 at 2016. 6. 28
	 */
	moPage.onModelConstructDone_ExtCcrSSbTlsnReqCntList = function() {
		// 검색조건 초기 설정
...
//		ExtGroup.initSearchBox("grpSearch", ["grpData"]);
	...
	function doClearSch(){
		...
		util.Control.setValue(app, "iptPnt","");
	};
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				var voParam = {
						...
						p_strPnt 				: util.Control.getValue(app, "iptPnt")											// 수강인원 미만
				};
				...
				var vsTitle = vsSchYearRcdNm + " " + vsSmtRcdNm + " 과목별 수강신청 현황(합강)";
				...
				util.Report.open(app, "hojReport", "extCcrSSbTlsnReqCntList", voOzFormParam, voParam);
			}
		});
