...
/// <xtmlink path="./extCcrSSbTlsnReqList.xtm"/>

/**
 * 과목별 수강신청 현황
 * @class extCcrSSbTlsnReqList
 * @author 유형기 at 2016. 6. 28
 */
var extCcrSSbTlsnReqList = function() {
	var moPage = new Page();
	 ...
	 * @author 유형기 at 2016. 6. 28
	 */
	moPage.onModelConstructDone_ExtCcrSSbTlsnReqList = function() {
		// 검색조건 초기 설정
	...
	moPage.onClick_BtnSearch = function() {
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				var vsTitle = vsSchYearRcdNm + " " + vsSmtRcdNm + " 과목별 수강신청 현황";
				...
				util.Report.open(app, "hojReport", "extCcrSSbTlsnReqList", voOzFormParam, voParam);
