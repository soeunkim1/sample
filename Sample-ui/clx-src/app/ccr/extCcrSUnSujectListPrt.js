...
/// <xtmlink path="./extCcrSUnSujectListPrt.xtm"/>
 ...
 */
var extCcrSUnSujectListPrt = function() {
	var moPage = new Page();
	...
	moPage.onClick_BtnSearch = function() {
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				var vsTitle = vsSchYearRcdNm + " " + vsSmtRcdNm + " 대체과목 리스트";
				...
				util.Report.open(app, "hojReport", "extCcrSUnSujectListPrt", voOzFormParam, voParam);
			}
		});
	};
