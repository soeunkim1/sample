...
/// <xtmlink path="./extCcrSUnSujectPrt.xtm"/>

/**
 * 미개설 교과목 조회
 * @class extCcrSUnSujectPrt
 * @author 유형기 at 2016. 7. 1
 */
var extCcrSUnSujectPrt = function() {
	var moPage = new Page();
	 ...
	 * @author 유형기 at 2016. 7. 1
	 */
	moPage.onModelConstructDone_ExtCcrSUnSujectPrt = function() {
		// 검색조건 초기 설정
...
//		ExtGroup.initSearchBox("grpSearch", ["grpData"]);
		...
		util.Submit.send(app, "subOnLoad", function(pbSuccess){
			if(pbSuccess){
				...
				util.DataMap.setValue(app, "dmReqKey", "strSchDiv", "MAJ");
				util.Control.redraw(app, "rdSchDiv");
	...
	moPage.onClick_BtnSearch = function() {
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				var vsTitle = vsSchYearRcdNm + " " + vsSmtRcdNm + " 대체 인정과목표";
				...
				util.Report.open(app, "hojReport", "extCcrSUnSujectPrt", voOzFormParam, voParam);
			}
		});
	};
