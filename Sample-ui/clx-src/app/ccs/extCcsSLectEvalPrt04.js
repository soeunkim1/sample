...
/// <xtmlink path="./extCcsSLectEvalPrt04.xtm"/>
 ...
 */
var extCcsSLectEvalPrt04 = function() {
	var moPage = new Page();
...
//		ExtGroup.initSearchBox("grpSearch", ["grpData"]);
	...
	function doList() {	
		...
		var voOzFormParam = {
				  TITLE : "초과강의시간내역" //리포트타이틀
				, SUB_TITLE : "서브타이틀" //리포트서브타이틀		
				, FORM_TYPE : "flash"
			};	
			
			util.Report.open(app, "hojReport", "extCcsSLectEvalPrt04", voOzFormParam, voParam);
