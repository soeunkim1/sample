...
/// <xtmlink path="./extCcsSLectEvalPrt06.xtm"/>
 ...
 */
var extCcsSLectEvalPrt06 = function() {
	var moPage = new Page();
...
//		ExtGroup.initSearchBox("grpSearch", ["grpData"]);
		...
		util.Submit.send(app, "subOnLoad", function(pbSuccess){
			if(pbSuccess){
				...
				util.Control.redraw(app, ["cbbSchYearRcd", "cbbSmtRcd", "ipbSaNm", "radSchDiv"]);
				// 학년도 학기값 되돌리기위한 값
	...
	function doList() {	
		...
		var voOzFormParam = {
				  TITLE : "교과분담 소속별 인원수" //리포트타이틀
				, SUB_TITLE : "서브타이틀" //리포트서브타이틀		
				, FORM_TYPE : "flash"
			};	
			
		util.Report.open(app, "hojReport", "extCcsSLectEvalPrt06", voOzFormParam, voParam);
