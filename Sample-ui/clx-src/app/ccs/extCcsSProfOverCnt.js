...
/// <xtmlink path="./extCcsSProfOverCnt.xtm"/>
 ...
 */
var extCcsSProfOverCnt = function() {
	var moPage = new Page();
...
//		ExtGroup.initSearchBox("grpSearch", ["grpData"]);
	...
	function doList() {	
		...
		var voOzFormParam = {
				  TITLE : "교수별초과시수현황" //리포트타이틀
				, SUB_TITLE : "서브타이틀" //리포트서브타이틀		
				, FORM_TYPE : "flash"
			};	
			
			util.Report.open(app, "hojReport", "extCcsSProfOverCnt", voOzFormParam, voParam);
