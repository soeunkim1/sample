	...
	moPage.onClick_BtnSearch = function() {
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				var vsTitle = vsSchYearRcdNm + " " + vsSmtRcdNm + " 학생 시간표 중복";
				...
				util.Report.open(app, "hojReport", "extccsSPrt01", voOzFormParam, voParam);
			}
		});
