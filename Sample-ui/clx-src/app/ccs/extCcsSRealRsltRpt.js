...
/// <xtmlink path="./extCcsSRealRsltRpt.xtm"/>

/**
 * 보강실시 결과보고서
 * @class extCcsSRealRsltRpt
 * @author 박갑수 at 2016. 2. 4
 */
var extCcsSRealRsltRpt = function() {
	var moPage = new Page();
	 ...
	 * @author 박갑수 at 2016. 2. 4
	 */
	moPage.onModelConstructDone_ExtCcsSRealRsltRpt = function() {
...
//		alert("vsSchYearRcd"+vsSchYearRcd+"vsSmtRcd"+vsSmtRcd+"vsProfObjNo"+vsProfObjNo);
		...
		var voOzFormParam = {
				  TITLE : "보강실시 결과보고서" //리포트타이틀
				, SUB_TITLE : "(보강실시 3일내 자필작성 제출)" //리포트서브타이틀		
				, FORM_TYPE : "flash"
			};	
			
			util.Report.open(app, "hojReport", "extCcsSRealRsltRpt", voOzFormParam, voParam);
