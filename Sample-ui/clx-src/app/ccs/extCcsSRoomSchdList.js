...
/// <xtmlink path="./extCcsSRoomSchdList.xtm"/>
 ...
 */
var extCcsSRoomSchdList = function() {
	var moPage = new Page();
...
//		ExtGroup.initSearchBox("grpSearch", ["grpData"]);
	...
	function doList(poCallBackFunc) {			
		...
		var vsRoomNm			= util.DataMap.getValue(app, "dmResPopup", "strLectRoomNm");
		...
		var voParam = {
				...
				p_strRoomNm			: vsRoomNm, //--강의실명
				p_strMenuId 				: moPageInfo.menuId,														   // 메뉴ID
				p_strCheckAuthId 		: moUserInfo.id																// 사용자ID
			};
			
			var voOzFormParam = {
				  TITLE : "강의실 시간표" //리포트타이틀
				, SUB_TITLE : "서브타이틀" //리포트서브타이틀		
				, FORM_TYPE : "flash"
			};	
			
			util.Report.open(app, "hojReport", "extCcsSRoomSchdList", voOzFormParam, voParam);
