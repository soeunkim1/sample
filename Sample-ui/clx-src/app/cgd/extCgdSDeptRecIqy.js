...
/// <xtmlink path="./extCgdSDeptRecIqy.xtm"/>

/**
 * 과목별 수강신청 현황
 * @class extCgdSDeptRecIqy
 * @author 유형기 at 2016. 6. 28
 */
var extCgdSDeptRecIqy = function() {
	var moPage = new Page();
	 ...
	 * @author 유형기 at 2016. 6. 28
	 */
	moPage.onModelConstructDone_ExtCgdSDeptRecIqy = function() {
...
//		ExtGroup.initSearchBox("grpSearch", ["grpData"]);
		...
		util.Submit.send(app, "subOnLoad", function(pbSuccess){
			if(pbSuccess){
				...
				util.Control.redraw(app, ["cbbSchYearRcd", "cbbSmtRcd", "cbbListStatRcd"]);
								
				util.Control.setValue(app, "cbbListStatRcd", "CT301ATTE")				
	...
	function doClearSch(){
		...
		util.Control.setValue(app, "ipbClassRcd","");
	...
	moPage.onClick_BtnSearch = function() {
		...
		if(vsSchDiv == "DEPT"){
			...
			vsClassRcd	= util.Control.getValue(app, "ipbClassRcd");
			vsStatRcd		= util.Control.getValue(app, "cbbListStatRcd");
		}else{
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				var voParam = {
						...
						p_strListStatRcd		: vsStatRcd				        // 재적상태
				...
				util.Report.open(app, "hojReport", "extCgdSDeptRecIqy", voOzFormParam, voParam);
			}
		});
	...
	*/
	moPage.onValueChanged_Radiobutton4 = function() {
		...
		var vaDept = ["lblSaCdNm", "ipbSaCdNm", "btnSaCdNm", "lblGradeRcd", "ipbGradeRcd", "lblClassRcd", "ipbClassRcd", "lblListStatRcd", "cbbListStatRcd", "lblSchYearRcd","cbbSchYearRcd","lblSmtRcd","cbbSmtRcd"];
