...
/// <xtmlink path="./extCgdSRecSheet.xtm"/>

/**
 * 성적표발송
 * @class extCgdSRecSheet
 * @author 유형기 at 2016. 6. 28
 */
var extCgdSRecSheet = function() {
	var moPage = new Page();
	...
	},
	{
		...
		iKeyEndDate		:	"",
		oObjDivRcd		:	"/root/reqKey/strOgObjDivRcd",
	 ...
	 * @author 유형기 at 2016. 6. 28
	 */
	moPage.onModelConstructDone_ExtCgdSRecSheet = function() {
		// 검색조건 초기 설정
...
//		ExtGroup.initSearchBox("grpSearch", ["grpData"]);
		...
		util.Submit.send(app, "subOnLoad", function(pbSuccess){
			if(pbSuccess){
				...
				util.DataMap.setValue(app, "dmReqKey", "strOgCd", moUserInfo.asgnDeptCd);
				util.DataMap.setValue(app, "dmReqKey", "strOgObjDivRcd", moUserInfo.asgnDeptDivRcd);
			}
		}, true);
	};
	...
	function doClearSch(){
		...
		util.Control.setValue(app, "ipbStudNo", "");
	};
	...
	moPage.onClick_BtnSearch = function() {
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				util.Report.open(app, "hojReport", "extCgdSRecSheet", voOzFormParam, voParam);
			}
		});
