...
/// <xtmlink path="./extCgdSWarnPcnd.xtm"/>

/**
 * 대체 인정과목표
 * @class extCgdSWarnPcnd
 * @author 박갑수 at 2016. 6. 29
 */
var extCgdSWarnPcnd = function() {
	var moPage = new Page();
	 ...
	 * @author 박갑수 at 2016. 6. 29
	 */
	moPage.onModelConstructDone_ExtCgdSWarnPcnd = function() {
		// 검색조건 초기 설정
...
//		ExtGroup.initSearchBox("grpSearch", ["grpData"]);
	...
	moPage.onClick_BtnSearch = function() {
		...
		var vsTitle = vsSchYearRcdNm + " " + vsSmtRcdNm + "  학사 징계자 현황";
		...
		util.Report.open(app, "hojReport", "extCgdSWarnPcnd", voOzFormParam, voParam);
	}
