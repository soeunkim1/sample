...
/// <xtmlink path="./stdCgdCRecRcog.xtm"/>

/**
 * 성적인정관리
 * @class stdCgdCRecRcog
 * @author 박갑수 at 2016. 3. 28
 */
var stdCgdCRecRcog = function() {
	var moPage = new Page();
	 ...
	 * @author 박갑수 at 2016. 3. 28
	 */
	moPage.onModelConstructDone_StdCgdCRecRcog = function() {
		// 리피트 초기 설정
...
//		ExtRepeat.selectedAllPanel("rhCkbSelect");
	...
	moPage.onClick_BtnNew = function() {
		...
		util.Grid.setCellValue(app, "grdCgdRecRcog", "SMT_RCD", vsSmtRcd, vnIdx);
		...
		util.Grid.setCellValue(app, "grdCgdRecRcog", "RCOG_REC_PRP_RCD", "CD105EXH", vnIdx);
		// 객체구분 : 외부교과목[CC009OS]
		util.Grid.setCellValue(app, "grdCgdRecRcog", "RCOG_REC_OBJ_DIV_RCD", "CC009OS", vnIdx);
		// 인정성적단위 : 기타만점[CD10906]
		util.Grid.setCellValue(app, "grdCgdRecRcog", "RCOG_REC_UNIT_RCD", "CD10906", vnIdx);
...
//		ExtControl.refreshBind(["bindRecTrsfYn"]);
	};
