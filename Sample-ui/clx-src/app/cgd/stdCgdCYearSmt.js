...
/// <xtmlink path="./stdCgdCYearSmt.xtm"/>


/**
 * 성적 학년도 학기
 * @class stdCgdCYearSmt
 * @author 박갑수 at 2016. 3. 10
 */
var stdCgdCYearSmt = function() {
	var moPage = new Page();
	 ...
	 * @author 박갑수 at 2016. 3. 10
	 */
	moPage.onModelConstructDone_StdCgdCYearSmt = function() {
		
		// 단위시스템 설정 : 수업[CB001CCS]
		util.DataMap.setValue(app, "dmReqKey", "strUnitSystem", "CB001CGD");
