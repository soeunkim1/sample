...
/// <xtmlink path="./extCgtSDeedConferPrt.xtm"/>


var extCgtSDeedConferPrt = function() {
	var moPage = new Page();
	...
	moPage.onClick_BtnSearch = function() {
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				util.Report.open(app, "hojReport", "extCgtSDeedConferPrt", voOzFormParam, voParam);
