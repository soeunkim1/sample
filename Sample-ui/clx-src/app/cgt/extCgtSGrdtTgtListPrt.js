...
/// <xtmlink path="./extCgtSGrdtTgtListPrt.xtm"/>


var extCgtSGrdtTgtListPrt = function() {
	var moPage = new Page();
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				var voParam = {
				 ...
				 var voOzFormParam = {
							  TITLE :  "졸업대상자 명단"   //리포트타이틀
							, SUB_TITLE : "" 		         //리포트서브타이틀		
							, FORM_TYPE : "flash"
							};	
							
				util.Report.open(app, "hojReport", "extCgtSGrdtTgtListPrt", voOzFormParam, voParam);
