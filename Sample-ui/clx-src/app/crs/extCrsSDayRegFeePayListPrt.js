...
/// <xtmlink path="./extCrsSDayRegFeePayListPrt.xtm"/>


var extCrsSDayRegFeePayListPrt = function() {
	var moPage = new Page();
...
//		ExtGroup.initSearchBox("grpSearch",["grpData"]);
		...
		util.Submit.send(app, "subOnLoad", function(pbSuccess){
			if(pbSuccess){
				...
				util.Control.setValue(app, "rdbPrtDivCd", "1");
			}
		});
	};
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				var voParam = {
				 ...
				 var voOzFormParam = {
							  TITLE : "일별 등록금 납입명단" //리포트타이틀
							, SUB_TITLE : "" 		//리포트서브타이틀		
							, FORM_TYPE : "flash"
							};	
				
				util.Report.open(app, "hojReport", "extCrsSDayRegFeePayListPrt", voOzFormParam, voParam);	
