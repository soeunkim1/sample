...
/// <xtmlink path="./extCrsSEtcFeePayStudListPrt.xtm"/>


var extCrsSEtcFeePayStudListPrt = function() {
	var moPage = new Page();
	 ...
	 * @author Aeyoung Lee at 2016. 6. 22.
	 */
	moPage.onModelConstructDone_ExtCrsSEtcFeePayStudListPrt = function() {
		//검색조건 초기 설정
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				var voParam = {
				 ...
				 var voOzFormParam = {
							  TITLE : "자율경비 납부자 명단" //리포트타이틀
							, SUB_TITLE : "" 		//리포트서브타이틀		
							, FORM_TYPE : "flash"
							};	
							
				util.Report.open(app, "hojReport", "extCrsSEtcFeePayStudListPrt", voOzFormParam, voParam);
