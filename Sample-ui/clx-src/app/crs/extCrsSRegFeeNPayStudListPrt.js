...
/// <xtmlink path="./extCrsSRegFeeNPayStudListPrt.xtm"/>


var extCrsSRegFeeNPayStudListPrt = function() {
	var moPage = new Page();
	 ...
	 * @author Aeyoung Lee at 2016. 6. 22.
	 */
	moPage.onModelConstructDone_ExtCrsSRegFeeNPayStudListPrt = function() {
		//검색조건 초기 설정
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				var voParam = {
				 ...
				 var voOzFormParam = {
							  TITLE : "미등록생 명단" //리포트타이틀
							, SUB_TITLE : "" 		//리포트서브타이틀		
							, FORM_TYPE : "flash"
							};	
							
				util.Report.open(app, "hojReport", "extCrsSRegFeeNPayStudListPrt", voOzFormParam, voParam);
