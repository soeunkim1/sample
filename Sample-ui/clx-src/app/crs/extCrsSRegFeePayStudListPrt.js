...
/// <xtmlink path="./extCrsSRegFeePayStudListPrt.xtm"/>


var extCrsSRegFeePayStudListPrt = function() {
	var moPage = new Page();
	 ...
	 * @author Aeyoung Lee at 2016. 6. 22.
	 */
	moPage.onModelConstructDone_ExtCrsSRegFeePayStudListPrt = function() {
		//검색조건 초기 설정
	...
	moPage.onClick_BtnSearch = function() {
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				util.Report.open(app, "hojReport", "extCrsSRegFeePayStudListPrt", voOzFormParam, voParam);
