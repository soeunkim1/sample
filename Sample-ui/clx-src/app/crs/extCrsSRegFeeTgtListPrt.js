...
/// <xtmlink path="./extCrsSRegFeeTgtListPrt.xtm"/>


var extCrsSRegFeeTgtListPrt = function() {
	var moPage = new Page();
	 ...
	 * @author Aeyoung Lee at 2016. 6. 22.
	 */
	moPage.onModelConstructDone_ExtCrsSRegFeeTgtListPrt = function() {
		//검색조건 초기 설정
...
//		ExtGroup.initSearchBox("grpSearch",["grpData"]);
		...
		util.Submit.send(app, "subOnLoad", function(pbSuccess){
			if(pbSuccess){
				util.Control.redraw(app, ["cbbRegClsRcd"]);
			}
		});
	};
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				var voParam = {
						  ...
						  , p_strRegClsRcd : util.DataMap.getValue(app, "dmReqKey", "strRegClsRcd")				// 등록구분
				 ...
				 var voOzFormParam = {
							  TITLE : "등록대상자 명단" //리포트타이틀
							, SUB_TITLE : "" 		//리포트서브타이틀		
							, FORM_TYPE : "flash"
							};	
							
				util.Report.open(app, "hojReport", "extCrsSRegFeeTgtListPrt", voOzFormParam, voParam);
