...
///<xtmlink path="./extCsrSEntrRemoByProCenter.xtm"/>

var extCsrSEntrRemoByProCenter = function() {
   ...
   /**
	 ...
	 * @author Sunyoung Park, 2017.1.9
	 */	
	moPage.onModelConstructDone_ExtCsrSEntrRemoByProCenter = function() {
	//리피트 초기 설정
