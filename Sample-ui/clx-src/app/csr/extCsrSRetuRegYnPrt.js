...
///<xtmlink path="./extCsrSRetuRegYnPrt.xtm"/>

var extCsrSRetuRegYnPrt = function() {
	...
	function doList(poCallBackFunc) {
		...
		util.Submit.send(app, "subList",  function(pbSuccess) {
			if(pbSuccess){
				...
				util.Report.open(app, "hojReport", "extCsrSRetuRegYnPrt", voOzFormParam, voParam);
