...
/// <xtmlink path="./stdCsrPCnlAltRtn.xtm"/>

var stdCsrPCnlAltRtn = function() {
	var moPage = new Page();
	//임포트용 데이터 통신 오브젝트
	 ...
	 * @param 
	 * @return void
	 * @author Choi In Seong 2016. 2. 22.
	 */
	 ...
	 * @author	 Choi In Seong 2016. 2. 22.
	 */
	moPage.onModelConstructDone_StdCsrPCnlAltRtn = function() {
		//리피트 초기 설정
...
//		ExtRepeat.init(["frfCsrShregAltAbs","frfCsrShregAltRtn","frfCsrEnroll"]);
	...
	moPage.onClick_BtnSave = function() {
		...
		util.DataMap.setValue(app, "dmReqKey", "strPopTarget", "stdCsrPCnlAltRtn");
		//strCommand: popupMnu 
	...
	/**
	 * @desc  화면 온로드 
	                부모창에서 받아온 변수 셋팅, 휴학정보, 학적등록정보(주과정) Select
	 * @param
	 * @return void
	 * @author Choi In Seong 2016. 02. 22.
	 */
	function doOnLoad() {
		...
		util.Submit.send(app, "subOnLoad", function (pbSuccess) {
			if (pbSuccess){
				...
				util.FreeForm.setValue(app, "frfCsrShregAltRtn", "CANCEL_DT", vsCnlDt);
				
				util.Control.redraw(app, ["cbbFrfCancelRsnRcd", "dipFrfCancelDt", "optStudNo", "optStud", "optCourse"]);
