...
/// <xtmlink path="./extCssSScalStudListPrt.xtm"/>


var extCssSScalStudListPrt = function() {
	var moPage = new Page();
...
//		ExtGroup.initSearchBox("grpSearch",["grpData"]);
		...
		util.Submit.send(app, "subList", function(pbSuccess){
			if(pbSuccess){
				...
				var voParam = {
						  ...
						  , p_strRrocYear : util.DataMap.getValue(app, "dmReqKey", "strRrocYear")
						  , p_strGenderRcd : util.DataMap.getValue(app, "dmReqKey", "strGenderRcd")
				...
				util.Report.open(app, "hojReport", "extCssSScalStudListPrt", voOzFormParam, voParam);
	...
	/**
	 * @desc  기준날짜의 값을 리셋팅
	 * @param {String} psSubMission 서브미션명
	 * @return void
