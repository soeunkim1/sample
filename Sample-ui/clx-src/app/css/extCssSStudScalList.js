...
/// <xtmlink path="./extCssSStudScalList.xtm"/>


var extCssSStudScalList = function() {
	var moPage = new Page();
	//임포트용 데이터 통신 오브젝트
	...
	/**
	 * @desc import 헤더 초기화
	 * @member extCssSStudScalList
	 * @param
	 * @return void
	 * @author Aeyoung Lee 2016. 4. 15.
	 */
	 ...
	 * @author Aeyoung Lee 2016. 4. 15.
	 */	
	moPage.onModelConstructDone_ExtCssSStudScalList = function() {
		//리피트 초기 설정
//TO-BE: <ExtRepeat.init> 전환작업시 불필요하여 주석처리함(삭제 필요)(2020-12-21 : SULMOIHO)
//		ExtRepeat.init("rptStudScal");
		//검색조건 초기 설정
